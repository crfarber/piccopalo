...
values
  ('3/4 Sit-Up', 'core', false, 'beginner', 'Lie down on the floor and secure your feet. Your legs should be bent at the knees.
...
Repeat for the recommended amount of repetitions.', '3_4_Sit-Up/0.jpg', '3_4_Sit-Up'),
  ('Ab Crunch Machine', 'core', false, 'intermediate', 'Select a light resistance and sit down on the ab machine placing your feet under the pads provided and grabbing the top handles. Your arms should be bent at a 90 degree angle as you rest the triceps on the pads provided. This will be your starting position.

At the same time, begin to lift the legs up as you crunch your upper torso. Breathe out as you perform this movement. Tip: Be sure to use a slow and controlled motion. Concentrate on using your abs to move the weight while relaxing your legs and feet.

After a second pause, slowly return to the starting position as you breathe in.

Repeat the movement for the prescribed amount of repetitions.', 'Ab_Crunch_Machine/0.jpg', 'Ab_Crunch_Machine'),
  ('Advanced Kettlebell Windmill', 'core', false, 'intermediate', 'Clean and press a kettlebell overhead with one arm.
...
Pause for a second and reverse the motion back to the starting position.', 'Advanced_Kettlebell_Windmill/0.jpg', 'Advanced_Kettlebell_Windmill'),
  ('Air Bike', 'core', false, 'beginner', 'Lie flat on the floor with your lower back pressed to the ground. For this exercise, you will need to put your hands beside your head. Be careful however to not strain with the neck as you perform it. Now lift your shoulders into the crunch position.
...
Continue alternating in this manner until all of the recommended repetitions for each side have been completed.', 'Air_Bike/0.jpg', 'Air_Bike'),
  ('Alternate Hammer Curl', 'armen', false, 'beginner', 'Stand up with your torso upright and a dumbbell in each hand being held at arms length. The elbows should be close to the torso.
...
Continue alternating in this manner for the recommended amount of repetitions.', 'Alternate_Hammer_Curl/0.jpg', 'Alternate_Hammer_Curl'),
  ('Alternate Heel Touchers', 'core', false, 'beginner', 'Lie on the floor with the knees bent and the feet on the floor around 18-24 inches apart. Your arms should be extended by your side. This will be your starting position.
...
Continue alternating sides in this manner until all prescribed repetitions are done.', 'Alternate_Heel_Touchers/0.jpg', 'Alternate_Heel_Touchers'),
  ('Alternate Incline Dumbbell Curl', 'armen', false, 'beginner', 'Sit down on an incline bench with a dumbbell in each hand being held at arms length. Tip: Keep the elbows close to the torso.This will be your starting position.
...
Continue alternating in this manner for the recommended amount of repetitions.', 'Alternate_Incline_Dumbbell_Curl/0.jpg', 'Alternate_Incline_Dumbbell_Curl'),
  ('Alternating Cable Shoulder Press', 'schouders', false, 'beginner', 'Move the cables to the bottom of the tower and select an appropriate weight.

Grasp the cables and hold them at shoulder height, palms facing forward. This will be your starting position.

Keeping your head and chest up, extend through the elbow to press one side directly over head.

After pausing at the top, return to the starting position and repeat on the opposite side.', 'Alternating_Cable_Shoulder_Press/0.jpg', 'Alternating_Cable_Shoulder_Press'),
  ('Alternating Deltoid Raise', 'schouders', false, 'beginner', 'In a standing position, hold a pair of dumbbells at your side.
...
Return the weights to the starting position and continue alternating to the front and side.', 'Alternating_Deltoid_Raise/0.jpg', 'Alternating_Deltoid_Raise'),
  ('Alternating Floor Press', 'borst', false, 'beginner', 'Lie on the floor with two kettlebells next to your shoulders.

Position one in place on your chest and then the other, gripping the kettlebells on the handle with the palms facing forward.

Extend both arms, so that the kettlebells are being held above your chest. Lower one kettlebell, bringing it to your chest and turn the wrist in the direction of the locked out kettlebell.

Raise the kettlebell and repeat on the opposite side.', 'Alternating_Floor_Press/0.jpg', 'Alternating_Floor_Press'),
  ('Alternating Hang Clean', 'benen', false, 'intermediate', 'Place two kettlebells between your feet. To get in the starting position, push your butt back and look straight ahead.

Clean one kettlebell to your shoulder and hold on to the other kettlebell in a hanging position. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulders. Rotate your wrist as you do so.

Lower the cleaned kettlebell to a hanging position and clean the alternate kettlebell. Repeat.', 'Alternating_Hang_Clean/0.jpg', 'Alternating_Hang_Clean'),
  ('Alternating Kettlebell Press', 'schouders', false, 'intermediate', 'Clean two kettlebells to your shoulders. Clean the kettlebells to your shoulders by extending through the legs and hips as you pull the kettlebells towards your shoulders. Rotate your wrists as you do so.

Press one directly overhead by extending through the elbow, turning it so the palm faces forward while holding the other kettlebell stationary .

Lower the pressed kettlebell to the starting position and immediately press with your other arm.', 'Alternating_Kettlebell_Press/0.jpg', 'Alternating_Kettlebell_Press'),
  ('Alternating Kettlebell Row', 'rug', false, 'intermediate', 'Place two kettlebells in front of your feet. Bend your knees slightly and push your butt out as much as possible. As you bend over to get into the starting position grab both kettlebells by the handles.
...
Lower the kettlebell in the working arm and repeat with your other arm.', 'Alternating_Kettlebell_Row/0.jpg', 'Alternating_Kettlebell_Row'),
  ('Alternating Renegade Row', 'rug', false, 'expert', 'Place two kettlebells on the floor about shoulder width apart. Position yourself on your toes and your hands as though you were doing a pushup, with the body straight and extended. Use the handles of the kettlebells to support your upper body. You may need to position your feet wide for support.

Push one kettlebell into the floor and row the other kettlebell, retracting the shoulder blade of the working side as you flex the elbow, pulling it to your side.

Then lower the kettlebell to the floor and begin the kettlebell in the opposite hand. Repeat for several reps.', 'Alternating_Renegade_Row/0.jpg', 'Alternating_Renegade_Row'),
  ('Anti-Gravity Press', 'schouders', false, 'beginner', 'Place a bar on the ground behind the head of an incline bench.

Lay on the bench face down. With a pronated grip, pick the barbell up from the floor. Flex the elbows, performing a reverse curl to bring the bar near your chest. This will be your starting position.

To begin, press the barbell out in front of your head by extending your elbows. Keep your arms parallel to the ground throughout the movement.

Return to the starting position and repeat to complete the set.', 'Anti-Gravity_Press/0.jpg', 'Anti-Gravity_Press'),
  ('Arnold Dumbbell Press', 'schouders', false, 'intermediate', 'Sit on an exercise bench with back support and hold two dumbbells in front of you at about upper chest level with your palms facing your body and your elbows bent. Tip: Your arms should be next to your torso. The starting position should look like the contracted portion of a dumbbell curl.
...
Repeat for the recommended amount of repetitions.', 'Arnold_Dumbbell_Press/0.jpg', 'Arnold_Dumbbell_Press'),
  ('Around The Worlds', 'borst', false, 'intermediate', 'Lay down on a flat bench holding a dumbbell in each hand with the palms of the hands facing towards the ceiling. Tip: Your arms should be parallel to the floor and next to your thighs. To avoid injury, make sure that you keep your elbows slightly bent. This will be your starting position.

Now move the dumbbells by creating a semi-circle as you displace them from the initial position to over the head. All of the movement should happen with the arms parallel to the floor at all times. Breathe in as you perform this portion of the movement.

Reverse the movement to return the weight to the starting position as you exhale.', 'Around_The_Worlds/0.jpg', 'Around_The_Worlds'),
  ('Barbell Ab Rollout', 'core', false, 'intermediate', 'For this exercise you will need to get into a pushup position, but instead of having your hands of the floor, you will be grabbing on to an Olympic barbell (loaded with 5-10 lbs on each side) instead. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Barbell_Ab_Rollout/0.jpg', 'Barbell_Ab_Rollout'),
  ('Barbell Ab Rollout - On Knees', 'core', false, 'expert', 'Hold an Olympic barbell loaded with 5-10lbs on each side and kneel on the floor.
...
After a second pause at the stretched position, start pulling yourself back to the starting position as you breathe out. Tip: Go slowly and keep your abs tight at all times.', 'Barbell_Ab_Rollout_-_On_Knees/0.jpg', 'Barbell_Ab_Rollout_-_On_Knees'),
  ('Barbell Bench Press - Medium Grip', 'borst', false, 'beginner', 'Lie back on a flat bench. Using a medium width grip (a grip that creates a 90-degree angle in the middle of the movement between the forearms and the upper arms), lift the bar from the rack and hold it straight over you with your arms locked. This will be your starting position.
...
When you are done, place the bar back in the rack.', 'Barbell_Bench_Press_-_Medium_Grip/0.jpg', 'Barbell_Bench_Press_-_Medium_Grip'),
  ('Barbell Curl', 'armen', false, 'beginner', 'Stand up with your torso upright while holding a barbell at a shoulder-width grip. The palm of your hands should be facing forward and the elbows should be close to the torso. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Barbell_Curl/0.jpg', 'Barbell_Curl'),
  ('Barbell Curls Lying Against An Incline', 'armen', false, 'beginner', 'Lie against an incline bench, with your arms holding a barbell and hanging down in a horizontal line. This will be your starting position.

While keeping the upper arms stationary, curl the weight up as high as you can while squeezing the biceps. Breathe out as you perform this portion of the movement. Tip: Only the forearms should move. Do not swing the arms.

After a second contraction, slowly go back to the starting position as you inhale. Tip: Make sure that you go all of the way down.

Repeat for the recommended amount of repetitions.', 'Barbell_Curls_Lying_Against_An_Incline/0.jpg', 'Barbell_Curls_Lying_Against_An_Incline'),
  ('Barbell Deadlift', 'rug', false, 'intermediate', 'Stand in front of a loaded barbell.
...
Perform the amount of repetitions prescribed in the program.', 'Barbell_Deadlift/0.jpg', 'Barbell_Deadlift'),
  ('Barbell Full Squat', 'benen', false, 'intermediate', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack just above shoulder level. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Repeat for the recommended amount of repetitions.', 'Barbell_Hack_Squat/0.jpg', 'Barbell_Hack_Squat'),
  ('Barbell Incline Bench Press - Medium Grip', 'borst', false, 'beginner', 'Lie back on an incline bench. Using a medium-width grip (a grip that creates a 90-degree angle in the middle of the movement between the forearms and the upper arms), lift the bar from the rack and hold it straight over you with your arms locked. This will be your starting position.
...
When you are done, place the bar back in the rack.', 'Barbell_Incline_Bench_Press_-_Medium_Grip/0.jpg', 'Barbell_Incline_Bench_Press_-_Medium_Grip'),
  ('Barbell Incline Shoulder Raise', 'schouders', false, 'beginner', 'Lie back on an Incline Bench. Using a medium width grip (a grip that is slightly wider than shoulder width), lift the bar from the rack and hold it straight over you with your arms straight. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Barbell_Incline_Shoulder_Raise/0.jpg', 'Barbell_Incline_Shoulder_Raise'),
  ('Barbell Lunge', 'benen', false, 'intermediate', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack just below shoulder level. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Repeat the movement for the recommended amount of repetitions and then perform with the left leg.', 'Barbell_Lunge/0.jpg', 'Barbell_Lunge'),
  ('Barbell Rear Delt Row', 'schouders', false, 'beginner', 'Stand up straight while holding a barbell using a wide (higher than shoulder width) and overhand (palms facing your body) grip.
...
Repeat for the recommended amount of repetitions.', 'Barbell_Rear_Delt_Row/0.jpg', 'Barbell_Rear_Delt_Row'),
  ('Barbell Rollout from Bench', 'core', false, 'intermediate', 'Place a loaded barbell on the ground, near the end of a bench. Kneel with both legs on the bench, and take a medium to narrow grip on the barbell. This will be your starting position.
...
When the bar has been moved as far forward as possible, return to the starting position.', 'Barbell_Rollout_from_Bench/0.jpg', 'Barbell_Rollout_from_Bench'),
  ('Barbell Seated Calf Raise', 'benen', false, 'beginner', 'Place a block about 12 inches in front of a flat bench.
...
Repeat for the recommended amount of repetitions.', 'Barbell_Seated_Calf_Raise/0.jpg', 'Barbell_Seated_Calf_Raise'),
  ('Barbell Shoulder Press', 'schouders', false, 'intermediate', 'Sit on a bench with back support in a squat rack. Position a barbell at a height that is just above your head. Grab the barbell with a pronated grip (palms facing forward).
...
Repeat for the recommended amount of repetitions.', 'Barbell_Shoulder_Press/0.jpg', 'Barbell_Shoulder_Press'),
  ('Barbell Shrug', 'rug', false, 'beginner', 'Stand up straight with your feet at shoulder width as you hold a barbell with both hands in front of you using a pronated grip (palms facing the thighs). Tip: Your hands should be a little wider than shoulder width apart. You can use wrist wraps for this exercise for a better grip. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Barbell_Shrug_Behind_The_Back/0.jpg', 'Barbell_Shrug_Behind_The_Back'),
  ('Barbell Side Bend', 'core', false, 'beginner', 'Stand up straight while holding a barbell placed on the back of your shoulders (slightly below the neck). Your feet should be shoulder width apart. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Barbell_Side_Bend/0.jpg', 'Barbell_Side_Bend'),
  ('Barbell Side Split Squat', 'benen', false, 'beginner', 'Stand up straight while holding a barbell placed on the back of your shoulders (slightly below the neck). Your feet should be placed wide apart with the foot of the lead leg angled out to the side. This will be your starting position.
...
After performing the recommended amount of reps, repeat the movement with the opposite leg.', 'Barbell_Side_Split_Squat/0.jpg', 'Barbell_Side_Split_Squat'),
  ('Barbell Squat', 'benen', false, 'beginner', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack to just below shoulder level. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Repeat for the recommended amount of repetitions.', 'Barbell_Squat/0.jpg', 'Barbell_Squat'),
  ('Barbell Squat To A Bench', 'benen', false, 'expert', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first place a flat bench or a box behind you. The flat bench is used to teach you to set your hips back and to hit depth.
...
Repeat for the recommended amount of repetitions.', 'Barbell_Squat_To_A_Bench/0.jpg', 'Barbell_Squat_To_A_Bench'),
  ('Barbell Step Ups', 'benen', false, 'intermediate', 'Stand up straight while holding a barbell placed on the back of your shoulders (slightly below the neck) and stand upright behind an elevated platform (such as the one used for spotting behind a flat bench). This is your starting position.
...
Repeat with the right leg for the recommended amount of repetitions and then perform with the left leg.', 'Barbell_Step_Ups/0.jpg', 'Barbell_Step_Ups'),
  ('Barbell Walking Lunge', 'benen', false, 'beginner', 'Begin standing with your feet shoulder width apart and a barbell across your upper back.

Step forward with one leg, flexing the knees to drop your hips. Descend until your rear knee nearly touches the ground. Your posture should remain upright, and your front knee should stay above the front foot.

Drive through the heel of your lead foot and extend both knees to raise yourself back up.

Step forward with your rear foot, repeating the lunge on the opposite leg.', 'Barbell_Walking_Lunge/0.jpg', 'Barbell_Walking_Lunge'),
  ('Bench Dips', 'armen', false, 'beginner', 'For this exercise you will need to place a bench behind your back. With the bench perpendicular to your body, and while looking away from it, hold on to the bench on its edge with the hands fully extended, separated at shoulder width. The legs will be extended forward, bent at the waist and perpendicular to your torso. This will be your starting position.

Slowly lower your body as you inhale by bending at the elbows until you lower yourself far enough to where there is an angle slightly smaller than 90 degrees between the upper arm and the forearm. Tip: Keep the elbows as close as possible throughout the movement. Forearms should always be pointing down.

Using your triceps to bring your torso up again, lift yourself back to the starting position.

Repeat for the recommended amount of repetitions.', 'Bench_Dips/0.jpg', 'Bench_Dips'),
  ('Bent-Arm Barbell Pullover', 'rug', false, 'intermediate', 'Lie on a flat bench with a barbell using a shoulder grip width.
...
Hold the weight on the initial position for a second and repeat the motion for the prescribed number of repetitions.', 'Bent-Arm_Barbell_Pullover/0.jpg', 'Bent-Arm_Barbell_Pullover'),
  ('Bent-Arm Dumbbell Pullover', 'borst', false, 'intermediate', 'Place a dumbbell standing up on a flat bench.
...
Hold the weight on the initial position for a second and repeat the motion for the prescribed number of repetitions.', 'Bent-Arm_Dumbbell_Pullover/0.jpg', 'Bent-Arm_Dumbbell_Pullover'),
  ('Bent-Knee Hip Raise', 'core', false, 'beginner', 'Lay flat on the floor with your arms next to your sides.
...
Repeat for the recommended amount of repetitions.', 'Bent-Knee_Hip_Raise/0.jpg', 'Bent-Knee_Hip_Raise'),
  ('Bent Over Barbell Row', 'rug', false, 'beginner', 'Holding a barbell with a pronated grip (palms facing down), bend your knees slightly and bring your torso forward, by bending at the waist, while keeping the back straight until it is almost parallel to the floor. Tip: Make sure that you keep the head up. The barbell should hang directly in front of you as your arms hang perpendicular to the floor and your torso. This is your starting position.

Now, while keeping the torso stationary, breathe out and lift the barbell to you. Keep the elbows close to the body and only use the forearms to hold the weight. At the top contracted position, squeeze the back muscles and hold for a brief pause.

Then inhale and slowly lower the barbell back to the starting position.

Repeat for the recommended amount of repetitions.', 'Bent_Over_Barbell_Row/0.jpg', 'Bent_Over_Barbell_Row'),
  ('Bent Over Dumbbell Rear Delt Raise With Head On Bench', 'schouders', false, 'beginner', 'Stand up straight while holding a dumbbell in each hand and with an incline bench in front of you.
...
Repeat the recommended amount of repetitions.', 'Bent_Over_Dumbbell_Rear_Delt_Raise_With_Head_On_Bench/0.jpg', 'Bent_Over_Dumbbell_Rear_Delt_Raise_With_Head_On_Bench'),
  ('Bent Over Low-Pulley Side Lateral', 'schouders', false, 'beginner', 'Select a weight and hold the handle of the low pulley with your right hand.
...
Repeat for the recommended amount of repetitions and repeat the movement with the other arm.', 'Bent_Over_Low-Pulley_Side_Lateral/0.jpg', 'Bent_Over_Low-Pulley_Side_Lateral'),
  ('Bent Over One-Arm Long Bar Row', 'rug', false, 'beginner', 'Put weight on one of the ends of an Olympic barbell. Make sure that you either place the other end of the barbell in the corner of two walls; or put a heavy object on the ground so the barbell cannot slide backward.
...
Repeat for the recommended amount of repetitions and switch arms.', 'Bent_Over_One-Arm_Long_Bar_Row/0.jpg', 'Bent_Over_One-Arm_Long_Bar_Row'),
  ('Bent Over Two-Arm Long Bar Row', 'rug', false, 'intermediate', 'Put weight on one of the ends of an Olympic barbell. Make sure that you either place the other end of the barbell in the corner of two walls; or put a heavy object on the ground so the barbell cannot slide backward.
...
Repeat for the recommended amount of repetitions.', 'Bent_Over_Two-Arm_Long_Bar_Row/0.jpg', 'Bent_Over_Two-Arm_Long_Bar_Row'),
  ('Bent Over Two-Dumbbell Row', 'rug', false, 'beginner', 'With a dumbbell in each hand (palms facing your torso), bend your knees slightly and bring your torso forward by bending at the waist; as you bend make sure to keep your back straight until it is almost parallel to the floor. Tip: Make sure that you keep the head up. The weights should hang directly in front of you as your arms hang perpendicular to the floor and your torso. This is your starting position.
...
Repeat for the recommended amount of repetitions.', 'Bent_Over_Two-Dumbbell_Row/0.jpg', 'Bent_Over_Two-Dumbbell_Row'),
  ('Bent Over Two-Dumbbell Row With Palms In', 'rug', false, 'beginner', 'With a dumbbell in each hand (palms facing each other), bend your knees slightly and bring your torso forward, by bending at the waist, while keeping the back straight until it is almost parallel to the floor. Tip: Make sure that you keep the head up. The weights should hang directly in front of you as your arms hang perpendicular to the floor and your torso. This is your starting position.
...
Repeat for the recommended amount of repetitions.', 'Bent_Over_Two-Dumbbell_Row_With_Palms_In/0.jpg', 'Bent_Over_Two-Dumbbell_Row_With_Palms_In'),
  ('Bent Press', 'core', false, 'expert', 'Clean a kettlebell to your shoulder. Clean the kettlebell to your shoulders by extending through the legs and hips as you raise the kettlebell towards your shoulder. The wrist should rotate as you do so. This will be your starting position.
...
Return to an upright position, with the kettlebell above your head. Return the kettlebell to the shoulder and repeat for the desired number of repetitions.', 'Bent_Press/0.jpg', 'Bent_Press'),
  ('Body-Up', 'armen', false, 'intermediate', 'Assume a plank position on the ground. You should be supporting your bodyweight on your toes and forearms, keeping your torso straight. Your forearms should be shoulder-width apart. This will be your starting position.
...
Repeat.', 'Body-Up/0.jpg', 'Body-Up'),
  ('Body Tricep Press', 'armen', false, 'beginner', 'Position a bar in a rack at chest height.
...
Progress from bodyweight by adding chains over your shoulders.', 'Body_Tricep_Press/0.jpg', 'Body_Tricep_Press'),
  ('Bodyweight Flyes', 'borst', false, 'intermediate', 'Position two equally loaded EZ bars on the ground next to each other. Ensure they are able to roll.
...
After moving the bars as far apart as you can, return to the starting position by pulling them back together. Exhale as you perform this movement.', 'Bodyweight_Flyes/0.jpg', 'Bodyweight_Flyes'),
  ('Bodyweight Squat', 'benen', false, 'beginner', 'Stand with your feet shoulder width apart. You can place your hands behind your head. This will be your starting position.

Begin the movement by flexing your knees and hips, sitting back with your hips.

Continue down to full depth if you are able,and quickly reverse the motion until you return to the starting position. As you squat, keep your head and chest up and push your knees out.', 'Bodyweight_Squat/0.jpg', 'Bodyweight_Squat'),
  ('Bosu Ball Cable Crunch With Side Bends', 'core', false, 'beginner', 'Connect a standard handle to each arm of a cable machine, and position them in the most downward position.
...
Lower your arms down to your side; keep them straight. Start doing alternating side bends; reach for your heels! This finishing movement will focus on your obliques.', 'Bosu_Ball_Cable_Crunch_With_Side_Bends/0.jpg', 'Bosu_Ball_Cable_Crunch_With_Side_Bends'),
  ('Bottoms-Up Clean From The Hang Position', 'armen', false, 'intermediate', 'Initiate the exercise by standing upright with a kettlebell in one hand.

Swing the kettlebell back forcefully and then reverse the motion forcefully. Crush the kettlebell handle as hard as possible and raise the kettlebell to your shoulder.', 'Bottoms-Up_Clean_From_The_Hang_Position/0.jpg', 'Bottoms-Up_Clean_From_The_Hang_Position'),
  ('Bottoms Up', 'core', false, 'beginner', 'Begin by lying on your back on the ground. Your legs should be straight and your arms at your side. This will be your starting position.
...
After a brief pause, return to the starting position.', 'Bottoms_Up/0.jpg', 'Bottoms_Up'),
  ('Box Squat with Chains', 'benen', false, 'expert', 'Begin in a power rack with a box at the appropriate height behind you. Typically, you would aim for a box height that brings you to a parallel squat, but you can train higher or lower if desired.
...
Keeping the weight on your heels and pushing your feet and knees out, drive upward off of the box as you lead the movement with your head. Continue upward, maintaining tightness head to toe.', 'Box_Squat_with_Chains/0.jpg', 'Box_Squat_with_Chains'),
  ('Bradford/Rocky Presses', 'schouders', false, 'beginner', 'Sit on a Military Press Bench with a bar at shoulder level with a pronated grip (palms facing forward). Tip: Your grip should be wider than shoulder width and it should create a 90-degree angle between the forearm and the upper arm as the barbell goes down. This is your starting position.
...
Alternate in this manner until you complete the recommended amount of repetitions.', 'Bradford_Rocky_Presses/0.jpg', 'Bradford_Rocky_Presses'),
  ('Butt-Ups', 'core', false, 'beginner', 'Begin a pushup position but with your elbows on the ground and resting on your forearms. Your arms should be bent at a 90 degree angle.
...
Repeat for the recommended amount of repetitions.', 'Butt-Ups/0.jpg', 'Butt-Ups'),
  ('Butt Lift (Bridge)', 'benen', false, 'beginner', 'Lie flat on the floor on your back with the hands by your side and your knees bent. Your feet should be placed around shoulder width. This will be your starting position.

Pushing mainly with your heels, lift your hips off the floor while keeping your back straight. Breathe out as you perform this part of the motion and hold at the top for a second.

Slowly go back to the starting position as you breathe in.', 'Butt_Lift_Bridge/0.jpg', 'Butt_Lift_Bridge'),
  ('Butterfly', 'borst', false, 'beginner', 'Sit on the machine with your back flat on the pad.
...
Repeat for the recommended amount of repetitions.', 'Butterfly/0.jpg', 'Butterfly'),
  ('Cable Chest Press', 'borst', false, 'beginner', 'Adjust the weight to an appropriate amount and be seated, grasping the handles. Your upper arms should be about 45 degrees to the body, with your head and chest up. The elbows should be bent to about 90 degrees. This will be your starting position.
...
You can also execute this movement with your back off the pad, at an incline or decline, or alternate hands.', 'Cable_Chest_Press/0.jpg', 'Cable_Chest_Press'),
  ('Cable Crossover', 'borst', false, 'beginner', 'To get yourself into the starting position, place the pulleys on a high position (above your head), select the resistance to be used and hold the pulleys in each hand.
...
Hold for a second at the starting position and repeat the movement for the prescribed amount of repetitions.', 'Cable_Crossover/0.jpg', 'Cable_Crossover'),
  ('Cable Crunch', 'core', false, 'beginner', 'Kneel below a high pulley that contains a rope attachment.
...
Repeat for the recommended amount of repetitions.', 'Cable_Crunch/0.jpg', 'Cable_Crunch'),
  ('Cable Deadlifts', 'benen', false, 'beginner', 'Move the cables to the bottom of the towers and select an appropriate weight. Stand directly in between the uprights.
...
After reaching a full standing position, Return to the starting position and repeat.', 'Cable_Deadlifts/0.jpg', 'Cable_Deadlifts'),
  ('Cable Hammer Curls - Rope Attachment', 'armen', false, 'beginner', 'Attach a rope attachment to a low pulley and stand facing the machine about 12 inches away from it.
...
Repeat for the recommended amount of repetitions.', 'Cable_Hammer_Curls_-_Rope_Attachment/0.jpg', 'Cable_Hammer_Curls_-_Rope_Attachment'),
  ('Cable Hip Adduction', 'benen', false, 'beginner', 'Stand in front of a low pulley facing forward with one leg next to the pulley and the other one away.
...
Repeat for the recommended amount of repetitions and then repeat the same movement with the opposite leg.', 'Cable_Hip_Adduction/0.jpg', 'Cable_Hip_Adduction'),
  ('Cable Incline Pushdown', 'rug', false, 'beginner', 'Lie on incline an bench facing away from a high pulley machine that has a straight bar attachment on it.
...
Repeat for the recommended amount of repetitions.', 'Cable_Incline_Pushdown/0.jpg', 'Cable_Incline_Pushdown'),
  ('Cable Incline Triceps Extension', 'armen', false, 'beginner', 'Lie on incline an bench facing away from a high pulley machine that has a straight bar attachment on it.
...
Repeat for the recommended amount of repetitions.', 'Cable_Incline_Triceps_Extension/0.jpg', 'Cable_Incline_Triceps_Extension'),
  ('Cable Internal Rotation', 'schouders', false, 'beginner', 'Sit next to a low pulley sideways (with legs stretched in front of you or crossed) and grasp the single hand cable attachment with the arm nearest to the cable. Tip: If you can adjust the pulley''s height, you can use a flat bench to sit on instead.
...
Repeat for the recommended amount of repetitions and then repeat the movement with the next arm.', 'Cable_Internal_Rotation/0.jpg', 'Cable_Internal_Rotation'),
  ('Cable Iron Cross', 'borst', false, 'beginner', 'Begin by moving the pulleys to the high position, select the resistance to be used, and take a handle in each hand.
...
Continue the movement for the prescribed number of repetitions.', 'Cable_Iron_Cross/0.jpg', 'Cable_Iron_Cross'),
  ('Cable Judo Flip', 'core', false, 'beginner', 'Connect a rope attachment to a tower, and move the cable to the lowest pulley position. Stand with your side to the cable with a wide stance, and grab the rope with both hands.
...
Then, reposition and repeat the same series of movements on the opposite side.', 'Cable_Judo_Flip/0.jpg', 'Cable_Judo_Flip'),
  ('Cable Lying Triceps Extension', 'armen', false, 'beginner', 'Lie on a flat bench and grasp the straight bar attachment of a low pulley with a narrow overhand grip. Tip: The easiest way to do this is to have someone hand you the bar as you lay down.
...
Hold for a second at the contracted position and repeat for the recommended amount of repetitions.', 'Cable_Lying_Triceps_Extension/0.jpg', 'Cable_Lying_Triceps_Extension'),
  ('Cable One Arm Tricep Extension', 'armen', false, 'beginner', 'With your right hand, grasp a single handle attached to the high-cable pulley using a supinated (underhand; palms facing up) grip. You should be standing directly in front of the weight stack.
...
Repeat for the recommended amount of repetitions and then perform the same movement with the other arm.', 'Cable_One_Arm_Tricep_Extension/0.jpg', 'Cable_One_Arm_Tricep_Extension'),
  ('Cable Preacher Curl', 'armen', false, 'beginner', 'Place a preacher bench about 2 feet in front of a pulley machine.
...
Repeat for the recommended amount of repetitions.', 'Cable_Preacher_Curl/0.jpg', 'Cable_Preacher_Curl'),
  ('Cable Rear Delt Fly', 'schouders', false, 'beginner', 'Adjust the pulleys to the appropriate height and adjust the weight. The pulleys should be above your head.
...
Pause at the end of the motion before returning the handles to the start position.', 'Cable_Rear_Delt_Fly/0.jpg', 'Cable_Rear_Delt_Fly'),
  ('Cable Reverse Crunch', 'core', false, 'beginner', 'Connect an ankle strap attachment to a low pulley cable and position a mat on the floor in front of it.
...
Repeat the same movement to failure.', 'Cable_Reverse_Crunch/0.jpg', 'Cable_Reverse_Crunch'),
  ('Cable Rope Overhead Triceps Extension', 'armen', false, 'beginner', 'Attach a rope to the bottom pulley of the pulley machine.
...
Repeat for the recommended amount of repetitions.', 'Cable_Rope_Overhead_Triceps_Extension/0.jpg', 'Cable_Rope_Overhead_Triceps_Extension'),
  ('Cable Rope Rear-Delt Rows', 'schouders', false, 'beginner', 'Sit in the same position on a low pulley row station as you would if you were doing seated cable rows for the back.
...
Repeat for the recommended amount of repetitions.', 'Cable_Rope_Rear-Delt_Rows/0.jpg', 'Cable_Rope_Rear-Delt_Rows'),
  ('Cable Russian Twists', 'core', false, 'beginner', 'Connect a standard handle attachment, and position the cable to a middle pulley position.
...
Then, reposition and repeat the same series of movements on the opposite side.', 'Cable_Russian_Twists/0.jpg', 'Cable_Russian_Twists'),
  ('Cable Seated Crunch', 'core', false, 'beginner', 'Seat on a flat bench with your back facing a high pulley.
...
Repeat for the recommended amount of repetitions.', 'Cable_Seated_Crunch/0.jpg', 'Cable_Seated_Crunch'),
  ('Cable Seated Lateral Raise', 'schouders', false, 'beginner', 'Stand in the middle of two low pulleys that are opposite to each other and place a flat bench right behind you (in perpendicular fashion to you; the narrow edge of the bench should be the one behind you). Select the weight to be used on each pulley.
...
Repeat for the recommended amount of repetitions. Tip: Maintain upper arms perpendicular to torso and a fixed elbow position (10 degree to 30 degree angle) throughout exercise.', 'Cable_Seated_Lateral_Raise/0.jpg', 'Cable_Seated_Lateral_Raise'),
  ('Cable Shoulder Press', 'schouders', false, 'beginner', 'Move the cables to the bottom of the towers and select an appropriate weight.
...
After pausing at the top, return to the starting position and repeat.', 'Cable_Shoulder_Press/0.jpg', 'Cable_Shoulder_Press'),
  ('Cable Shrugs', 'rug', false, 'beginner', 'Grasp a cable bar attachment that is attached to a low pulley with a shoulder width or slightly wider overhand (palms facing down) grip.
...
Repeat for the recommended amount of repetitions.', 'Cable_Shrugs/0.jpg', 'Cable_Shrugs'),
  ('Cable Wrist Curl', 'armen', false, 'beginner', 'Start out by placing a flat bench in front of a low pulley cable that has a straight bar attachment.
...
Repeat for the recommended amount of repetitions.', 'Cable_Wrist_Curl/0.jpg', 'Cable_Wrist_Curl'),
  ('Calf-Machine Shoulder Shrug', 'rug', false, 'beginner', 'Position yourself on the calf machine so that the shoulder pads are above your shoulders. Your torso should be straight with the arms extended normally by your side. This will be your starting position.

Raise your shoulders up towards your ears as you exhale and hold the contraction for a full second.

Slowly return to the starting position as you inhale.

Repeat for the recommended amount of repetitions.', 'Calf-Machine_Shoulder_Shrug/0.jpg', 'Calf-Machine_Shoulder_Shrug'),
  ('Calf Press', 'benen', false, 'beginner', 'Adjust the seat so that your legs are only slightly bent in the start position. The balls of your feet should be firmly on the platform.
...
After a brief pause, reverse the motion and repeat.', 'Calf_Press/0.jpg', 'Calf_Press'),
  ('Calf Press On The Leg Press Machine', 'benen', false, 'beginner', 'Using a leg press machine, sit down on the machine and place your legs on the platform directly in front of you at a medium (shoulder width) foot stance.
...
Repeat for the recommended amount of repetitions.', 'Calf_Press_On_The_Leg_Press_Machine/0.jpg', 'Calf_Press_On_The_Leg_Press_Machine'),
  ('Calf Raise On A Dumbbell', 'benen', false, 'intermediate', 'Hang on to a sturdy object for balance and stand on a dumbbell handle, preferably one with round plates so that it rolls as in this manner you have to work harder to stabilize yourself; thus increasing the effectiveness of the exercise.
...
Repeat for the recommended amount of repetitions.', 'Calf_Raise_On_A_Dumbbell/0.jpg', 'Calf_Raise_On_A_Dumbbell'),
  ('Car Drivers', 'schouders', false, 'beginner', 'While standing upright, hold a barbell plate in both hands at the 3 and 9 o''clock positions. Your palms should be facing each other and your arms should be extended straight out in front of you. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Car_Drivers/0.jpg', 'Car_Drivers'),
  ('Chair Squat', 'benen', false, 'beginner', 'To begin, first set the bar to a position that best matches your height. Once the bar is loaded, step under it and position it across the back of your shoulders.
...
Repeat for the recommended amount of repetitions.', 'Chair_Squat/0.jpg', 'Chair_Squat'),
  ('Chin-Up', 'rug', false, 'beginner', 'Grab the pull-up bar with the palms facing your torso and a grip closer than the shoulder width.
...
Repeat this motion for the prescribed amount of repetitions.', 'Chin-Up/0.jpg', 'Chin-Up'),
  ('Clean and Press', 'schouders', false, 'intermediate', 'Assume a shoulder-width stance, with knees inside the arms. Now while keeping the back flat, bend at the knees and hips so that you can grab the bar with the arms fully extended and a pronated grip that is slightly wider than shoulder width. Point the elbows out to sides. The bar should be close to the shins. Position the shoulders over or slightly ahead of the bar. Establish a flat back posture. This will be your starting position.
...
Without moving your feet, press the bar overhead as you exhale. Lower the bar under control .', 'Clean_and_Press/0.jpg', 'Clean_and_Press'),
  ('Clock Push-Up', 'borst', false, 'intermediate', 'Move into a prone position on the floor, supporting your weight on your hands and toes.
...
Return to the starting position and repeat the exercise, working all the way around until you are back where you started.', 'Clock_Push-Up/0.jpg', 'Clock_Push-Up'),
  ('Close-Grip Barbell Bench Press', 'armen', false, 'beginner', 'Lie back on a flat bench. Using a close grip (around shoulder width), lift the bar from the rack and hold it straight over you with your arms locked. This will be your starting position.
...
When you are done, place the bar back in the rack.', 'Close-Grip_Barbell_Bench_Press/0.jpg', 'Close-Grip_Barbell_Bench_Press'),
  ('Close-Grip Dumbbell Press', 'armen', false, 'beginner', 'Place a dumbbell standing up on a flat bench.
...
Return to the starting position by extending the elbows.', 'Close-Grip_Dumbbell_Press/0.jpg', 'Close-Grip_Dumbbell_Press'),
  ('Close-Grip EZ-Bar Curl with Band', 'armen', false, 'beginner', 'Attach a band to each end of the bar. Take the bar, placing a foot on the middle of the band. Stand upright with a narrow, supinated grip on the EZ bar. The elbows should be close to the torso. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Close-Grip_EZ-Bar_Curl_with_Band/0.jpg', 'Close-Grip_EZ-Bar_Curl_with_Band'),
  ('Close-Grip EZ-Bar Press', 'armen', false, 'beginner', 'Lie on a flat bench with an EZ bar loaded to an appropriate weight.
...
Repeat.', 'Close-Grip_EZ-Bar_Press/0.jpg', 'Close-Grip_EZ-Bar_Press'),
  ('Close-Grip EZ Bar Curl', 'armen', false, 'beginner', 'Stand up with your torso upright while holding an E-Z Curl Bar at the closer inner handle. The palm of your hands should be facing forward and they should be slightly tilted inwards due to the shape of the bar. The elbows should be close to the torso. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Close-Grip_EZ_Bar_Curl/0.jpg', 'Close-Grip_EZ_Bar_Curl'),
  ('Close-Grip Front Lat Pulldown', 'rug', false, 'beginner', 'Sit down on a pull-down machine with a wide bar attached to the top pulley. Make sure that you adjust the knee pad of the machine to fit your height. These pads will prevent your body from being raised by the resistance attached to the bar.
...
6. Repeat this motion for the prescribed amount of repetitions.', 'Close-Grip_Front_Lat_Pulldown/0.jpg', 'Close-Grip_Front_Lat_Pulldown'),
  ('Close-Grip Push-Up off of a Dumbbell', 'armen', false, 'intermediate', 'Lie on the floor and place your hands on an upright dumbbell. Supporting your weight on your toes and hands, keep your torso rigid and your elbows in with your arms straight. This will be your starting position.
...
After a pause at the contracted position, repeat the movement for the prescribed amount of repetitions.', 'Close-Grip_Push-Up_off_of_a_Dumbbell/0.jpg', 'Close-Grip_Push-Up_off_of_a_Dumbbell'),
  ('Close-Grip Standing Barbell Curl', 'armen', false, 'beginner', 'Hold a barbell with both hands, palms up and a few inches apart.
...
Repeat for the recommended amount of repetitions.', 'Close-Grip_Standing_Barbell_Curl/0.jpg', 'Close-Grip_Standing_Barbell_Curl'),
  ('Cocoons', 'core', false, 'beginner', 'Begin by lying on your back on the ground. Your legs should be straight and your arms extended behind your head. This will be your starting position.
...
After a brief pause, return to the starting position.', 'Cocoons/0.jpg', 'Cocoons'),
  ('Concentration Curls', 'armen', false, 'beginner', 'Sit down on a flat bench with one dumbbell in front of you between your legs. Your legs should be spread with your knees bent and feet on the floor.
...
Repeat for the recommended amount of repetitions. Then repeat the movement with the left arm.', 'Concentration_Curls/0.jpg', 'Concentration_Curls'),
  ('Cross-Body Crunch', 'core', false, 'beginner', 'Lie flat on your back and bend your knees about 60 degrees.
...
Continue alternating in this manner until all prescribed repetitions are done.', 'Cross-Body_Crunch/0.jpg', 'Cross-Body_Crunch'),
  ('Cross Body Hammer Curl', 'armen', false, 'beginner', 'Stand up straight with a dumbbell in each hand. Your hands should be down at your side with your palms facing in.
...
Continue alternating in this fashion until the recommended amount of repetitions is performed for each arm.', 'Cross_Body_Hammer_Curl/0.jpg', 'Cross_Body_Hammer_Curl'),
  ('Crunch - Hands Overhead', 'core', false, 'beginner', 'Lie on the floor with your back flat and knees bent with around a 60-degree angle between the hamstrings and the calves.
...
Repeat for the recommended amount of repetitions.', 'Crunch_-_Hands_Overhead/0.jpg', 'Crunch_-_Hands_Overhead'),
  ('Crunch - Legs On Exercise Ball', 'core', false, 'beginner', 'Lie flat on your back with your feet resting on an exercise ball and your knees bent at a 90 degree angle.
...
Repeat for the recommended amount of repetitions.', 'Crunch_-_Legs_On_Exercise_Ball/0.jpg', 'Crunch_-_Legs_On_Exercise_Ball'),
  ('Crunches', 'core', false, 'beginner', 'Lie flat on your back with your feet flat on the ground, or resting on a bench with your knees bent at a 90 degree angle. If you are resting your feet on a bench, place them three to four inches apart and point your toes inward so they touch.
...
Repeat for the recommended amount of repetitions.', 'Crunches/0.jpg', 'Crunches'),
  ('Cuban Press', 'schouders', false, 'intermediate', 'Take a dumbbell in each hand with a pronated grip in a standing position. Raise your upper arms so that they are parallel to the floor, allowing your lower arms to hang in the "scarecrow" position. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Cuban_Press/0.jpg', 'Cuban_Press'),
  ('Dead Bug', 'core', false, 'beginner', 'Begin lying on your back with your hands extended above you toward the ceiling.
...
Repeat on the opposite side, alternating until the set is complete.', 'Dead_Bug/0.jpg', 'Dead_Bug'),
  ('Decline Barbell Bench Press', 'borst', false, 'beginner', 'Secure your legs at the end of the decline bench and slowly lay down on the bench.
...
When you are done, place the bar back in the rack.', 'Decline_Barbell_Bench_Press/0.jpg', 'Decline_Barbell_Bench_Press'),
  ('Decline Close-Grip Bench To Skull Crusher', 'armen', false, 'intermediate', 'Secure your legs at the end of the decline bench and slowly lay down on the bench.
...
Repeat steps 3-6 until the recommended amount of repetitions is performed.', 'Decline_Close-Grip_Bench_To_Skull_Crusher/0.jpg', 'Decline_Close-Grip_Bench_To_Skull_Crusher'),
  ('Decline Crunch', 'core', false, 'intermediate', 'Secure your legs at the end of the decline bench and lie down.
...
Repeat for the recommended amount of repetitions.', 'Decline_Crunch/0.jpg', 'Decline_Crunch'),
  ('Decline Dumbbell Bench Press', 'borst', false, 'beginner', 'Secure your legs at the end of the decline bench and lie down with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.
...
Repeat the movement for the prescribed amount of repetitions of your training program.', 'Decline_Dumbbell_Bench_Press/0.jpg', 'Decline_Dumbbell_Bench_Press'),
  ('Decline Dumbbell Flyes', 'borst', false, 'beginner', 'Secure your legs at the end of the decline bench and lie down with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.
...
Hold for a second at the contracted position and repeat the movement for the prescribed amount of repetitions.', 'Decline_Dumbbell_Flyes/0.jpg', 'Decline_Dumbbell_Flyes'),
  ('Decline Dumbbell Triceps Extension', 'armen', false, 'beginner', 'Secure your legs at the end of the decline bench and lie down with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.
...
Repeat for the recommended amount of repetitions.', 'Decline_Dumbbell_Triceps_Extension/0.jpg', 'Decline_Dumbbell_Triceps_Extension'),
  ('Decline EZ Bar Triceps Extension', 'armen', false, 'beginner', 'Secure your legs at the end of the decline bench and slowly lay down on the bench.
...
Repeat until the recommended amount of repetitions is performed.', 'Decline_EZ_Bar_Triceps_Extension/0.jpg', 'Decline_EZ_Bar_Triceps_Extension'),
  ('Decline Oblique Crunch', 'core', false, 'beginner', 'Secure your legs at the end of the decline bench and slowly lay down on the bench.
...
After completing one set on the right for the recommended amount of repetitions, switch to your left side. Tip: Focus on really twisting your torso and feeling the contraction when you are in the up position.', 'Decline_Oblique_Crunch/0.jpg', 'Decline_Oblique_Crunch'),
  ('Decline Reverse Crunch', 'core', false, 'beginner', 'Lie on your back on a decline bench and hold on to the top of the bench with both hands. Don''t let your body slip down from this position.
...
Repeat for the recommended amount of repetitions.', 'Decline_Reverse_Crunch/0.jpg', 'Decline_Reverse_Crunch'),
  ('Decline Smith Press', 'borst', false, 'beginner', 'Place a decline bench underneath the Smith machine. Now place the barbell at a height that you can reach when lying down and your arms are almost fully extended. Using a pronated grip that is wider than shoulder width, unlock the bar from the rack and hold it straight over you with your arms extended. This will be your starting position.
...
When the set is complete, lock the bar back in the rack.', 'Decline_Smith_Press/0.jpg', 'Decline_Smith_Press'),
  ('Dip Machine', 'armen', false, 'beginner', 'Sit securely in a dip machine, select the weight and firmly grasp the handles.
...
Repeat for the recommended amount of repetitions.', 'Dip_Machine/0.jpg', 'Dip_Machine'),
  ('Dips - Triceps Version', 'armen', false, 'beginner', 'To get into the starting position, hold your body at arm''s length with your arms nearly locked above the bars.

Now, inhale and slowly lower yourself downward. Your torso should remain upright and your elbows should stay close to your body. This helps to better focus on tricep involvement. Lower yourself until there is a 90 degree angle formed between the upper arm and forearm.

Then, exhale and push your torso back up using your triceps to bring your body back to the starting position.

Repeat the movement for the prescribed amount of repetitions.', 'Dips_-_Triceps_Version/0.jpg', 'Dips_-_Triceps_Version'),
  ('Double Kettlebell Alternating Hang Clean', 'benen', false, 'intermediate', 'Place two kettlebells between your feet. To get in the starting position, push your butt back and look straight ahead.

Clean one kettlebell to your shoulder and hold on to the other kettlebell.

With a fluid motion, lower the top kettlebell while driving the bottom kettlebell up.', 'Double_Kettlebell_Alternating_Hang_Clean/0.jpg', 'Double_Kettlebell_Alternating_Hang_Clean'),
  ('Double Kettlebell Jerk', 'schouders', false, 'intermediate', 'Hold a kettlebell by the handle in each hand.
...
Keeping the weights overhead, return to a standing position, bringing your feet together. Lower the weights to perform the next repetition.', 'Double_Kettlebell_Jerk/0.jpg', 'Double_Kettlebell_Jerk'),
  ('Double Kettlebell Push Press', 'schouders', false, 'intermediate', 'Clean two kettlebells to your shoulders.

Squat down a few inches and reverse the motion rapidly. Use the momentum from the legs to drive the kettlebells overhead.

Once the kettlebells are locked out, lower the kettlebells to your shoulders and repeat.', 'Double_Kettlebell_Push_Press/0.jpg', 'Double_Kettlebell_Push_Press'),
  ('Double Kettlebell Snatch', 'schouders', false, 'expert', 'Place two kettlebells behind your feet. Bend your knees and sit back to pick up the kettlebells.

Swing the kettlebells between your legs forcefully and reverse the direction.

Drive through with your hips and lock the ketttlebells overhead in one uninterrupted motion.', 'Double_Kettlebell_Snatch/0.jpg', 'Double_Kettlebell_Snatch'),
  ('Double Kettlebell Windmill', 'core', false, 'intermediate', 'Place a kettlebell in front of your front foot and clean and press a kettlebell overhead with your opposite arm. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulders. Rotate your wrist as you do so, so that the palm faces forward.
...
Pause for a second after retrieving the kettlebell from the ground and reverse the motion back to the starting position.', 'Double_Kettlebell_Windmill/0.jpg', 'Double_Kettlebell_Windmill'),
  ('Drag Curl', 'armen', false, 'intermediate', 'Grab a barbell with a supinated grip (palms facing forward) and get your elbows close to your torso and back. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Drag_Curl/0.jpg', 'Drag_Curl'),
  ('Dumbbell Alternate Bicep Curl', 'armen', false, 'beginner', 'Stand (torso upright) with a dumbbell in each hand held at arms length. The elbows should be close to the torso and the palms of your hand should be facing your thighs.
...
Continue alternating in this manner for the recommended amount of repetitions.', 'Dumbbell_Alternate_Bicep_Curl/0.jpg', 'Dumbbell_Alternate_Bicep_Curl'),
  ('Dumbbell Bench Press', 'borst', false, 'beginner', 'Lie down on a flat bench with a dumbbell in each hand resting on top of your thighs. The palms of your hands will be facing each other.
...
Repeat the movement for the prescribed amount of repetitions of your training program.', 'Dumbbell_Bench_Press/0.jpg', 'Dumbbell_Bench_Press'),
  ('Dumbbell Bench Press with Neutral Grip', 'borst', false, 'beginner', 'Take a dumbbell in each hand and lay back onto a flat bench. Your feet should be flat on the floor and your shoulder blades retracted.
...
Pause, then extend the elbow and return to the starting position.', 'Dumbbell_Bench_Press_with_Neutral_Grip/0.jpg', 'Dumbbell_Bench_Press_with_Neutral_Grip'),
  ('Dumbbell Bicep Curl', 'armen', false, 'beginner', 'Stand up straight with a dumbbell in each hand at arm''s length. Keep your elbows close to your torso and rotate the palms of your hands until they are facing forward. This will be your starting position.

Now, keeping the upper arms stationary, exhale and curl the weights while contracting your biceps. Continue to raise the weights until your biceps are fully contracted and the dumbbells are at shoulder level. Hold the contracted position for a brief pause as you squeeze your biceps.

Then, inhale and slowly begin to lower the dumbbells back to the starting position.

Repeat for the recommended amount of repetitions.', 'Dumbbell_Bicep_Curl/0.jpg', 'Dumbbell_Bicep_Curl'),
  ('Dumbbell Clean', 'benen', false, 'intermediate', 'Begin standing with a dumbbell in each hand with your feet shoulder width apart.
...
Upon receiving the weight in the squat position, extend the hips and knees to finish in a standing position with the weights on your shoulders.', 'Dumbbell_Clean/0.jpg', 'Dumbbell_Clean'),
  ('Dumbbell Flyes', 'borst', false, 'beginner', 'Lie down on a flat bench with a dumbbell on each hand resting on top of your thighs. The palms of your hand will be facing each other.
...
Hold for a second at the contracted position and repeat the movement for the prescribed amount of repetitions.', 'Dumbbell_Flyes/0.jpg', 'Dumbbell_Flyes'),
  ('Dumbbell Incline Row', 'rug', false, 'beginner', 'Using a neutral grip, lean into an incline bench.
...
Pause at the top of the motion, and then return to the starting position.', 'Dumbbell_Incline_Row/0.jpg', 'Dumbbell_Incline_Row'),
  ('Dumbbell Incline Shoulder Raise', 'schouders', false, 'beginner', 'Sit on an Incline Bench while holding a dumbbell on each hand on top of your thighs.
...
Repeat for the recommended amount of repetitions.', 'Dumbbell_Incline_Shoulder_Raise/0.jpg', 'Dumbbell_Incline_Shoulder_Raise'),
  ('Dumbbell Lunges', 'benen', false, 'beginner', 'Stand with your torso upright holding two dumbbells in your hands by your sides. This will be your starting position.
...
Repeat the movement for the recommended amount of repetitions and then perform with the left leg.', 'Dumbbell_Lunges/0.jpg', 'Dumbbell_Lunges'),
  ('Dumbbell Lying One-Arm Rear Lateral Raise', 'schouders', false, 'intermediate', 'While holding a dumbbell in one hand, lay with your chest down on a slightly inclined (around 15 degrees when measured from the floor) adjustable bench. The other hand can be used to hold to the leg of the bench for stability.
...
Repeat for the recommended amount of repetitions.', 'Dumbbell_Lying_One-Arm_Rear_Lateral_Raise/0.jpg', 'Dumbbell_Lying_One-Arm_Rear_Lateral_Raise'),
  ('Dumbbell Lying Pronation', 'armen', false, 'intermediate', 'Lie on a flat bench face down with one arm holding a dumbbell and the other hand on top of the bench folded so that you can rest your head on it.
...
Repeat for the recommended amount of repetitions.', 'Dumbbell_Lying_Pronation/0.jpg', 'Dumbbell_Lying_Pronation'),
  ('Dumbbell Lying Rear Lateral Raise', 'schouders', false, 'intermediate', 'While holding a dumbbell in each hand, lay with your chest down on a slightly inclined (around 15 degrees when measured from the floor) adjustable bench.
...
Repeat for the recommended amount of repetitions and then switch to the other arm.', 'Dumbbell_Lying_Rear_Lateral_Raise/0.jpg', 'Dumbbell_Lying_Rear_Lateral_Raise'),
  ('Dumbbell Lying Supination', 'armen', false, 'intermediate', 'Lie sideways on a flat bench with one arm holding a dumbbell and the other hand on top of the bench folded so that you can rest your head on it.
...
Repeat for the recommended amount of repetitions and then switch to the other arm.', 'Dumbbell_Lying_Supination/0.jpg', 'Dumbbell_Lying_Supination'),
  ('Dumbbell One-Arm Shoulder Press', 'schouders', false, 'intermediate', 'Grab a dumbbell and either sit on a military press bench or a utility bench that has a back support on it as you place the dumbbells upright on top of your thighs or stand up straight.
...
Repeat for the recommended amount of repetitions and then switch arms.', 'Dumbbell_One-Arm_Shoulder_Press/0.jpg', 'Dumbbell_One-Arm_Shoulder_Press'),
  ('Dumbbell One-Arm Triceps Extension', 'armen', false, 'intermediate', 'Grab a dumbbell and either sit on a military press bench or a utility bench that has a back support on it as you place the dumbbells upright on top of your thighs or stand up straight.
...
Repeat for the recommended amount of repetitions and switch arms.', 'Dumbbell_One-Arm_Triceps_Extension/0.jpg', 'Dumbbell_One-Arm_Triceps_Extension'),
  ('Dumbbell One-Arm Upright Row', 'schouders', false, 'intermediate', 'Grab a dumbbell and stand up straight with your arm extended in front of you with a slight bend at the elbows and your back straight. This will be your starting position. Tip: The dumbbell should be resting on top of your thigh with the palm of your hands facing your thighs.
...
Repeat for the recommended amount of repetitions and switch arms.', 'Dumbbell_One-Arm_Upright_Row/0.jpg', 'Dumbbell_One-Arm_Upright_Row'),
  ('Dumbbell Prone Incline Curl', 'armen', false, 'intermediate', 'Grab a dumbbell on each hand and lie face down on an incline bench with your shoulders near top of the incline. Your knees can rest on the seat or your legs can be straddled to the sides (my preferred way).
...
Repeat for the recommended amount of times.', 'Dumbbell_Prone_Incline_Curl/0.jpg', 'Dumbbell_Prone_Incline_Curl'),
  ('Dumbbell Raise', 'schouders', false, 'beginner', 'Grab a dumbbell in each arm and stand up straight with your arms extended by your sides with a slight bend at the elbows and your back straight. This will be your starting position. Tip: The dumbbell should be next to your thighs with the palm of your hands facing back.
...
Repeat for the recommended amount of repetitions.', 'Dumbbell_Raise/0.jpg', 'Dumbbell_Raise'),
  ('Dumbbell Rear Lunge', 'benen', false, 'intermediate', 'Stand with your torso upright holding two dumbbells in your hands by your sides. This will be your starting position.
...
Now repeat with the opposite leg.', 'Dumbbell_Rear_Lunge/0.jpg', 'Dumbbell_Rear_Lunge'),
  ('Dumbbell Scaption', 'schouders', false, 'beginner', 'This corrective exercise strengthens the muscles that stabilize your shoulder blade. Hold a light weight in each hand, hanging at your sides. Your thumbs should pointing up.
...
Continue until your arms are parallel to the ground, and then return to the starting position.', 'Dumbbell_Scaption/0.jpg', 'Dumbbell_Scaption'),
  ('Dumbbell Seated One-Leg Calf Raise', 'benen', false, 'beginner', 'Place a block on the floor about 12 inches from a flat bench.
...
Repeat for your prescribed number of repetitions and then repeat with the right leg.', 'Dumbbell_Seated_One-Leg_Calf_Raise/0.jpg', 'Dumbbell_Seated_One-Leg_Calf_Raise'),
  ('Dumbbell Shoulder Press', 'schouders', false, 'intermediate', 'While holding a dumbbell in each hand, sit on a military press bench or utility bench that has back support. Place the dumbbells upright on top of your thighs.
...
Repeat for the recommended amount of repetitions.', 'Dumbbell_Shoulder_Press/0.jpg', 'Dumbbell_Shoulder_Press'),
  ('Dumbbell Shrug', 'rug', false, 'beginner', 'Stand erect with a dumbbell on each hand (palms facing your torso), arms extended on the sides.
...
Repeat for the recommended amount of repetitions.', 'Dumbbell_Shrug/0.jpg', 'Dumbbell_Shrug'),
  ('Dumbbell Side Bend', 'core', false, 'beginner', 'Stand up straight while holding a dumbbell on the left hand (palms facing the torso) as you have the right hand holding your waist. Your feet should be placed at shoulder width. This will be your starting position.

While keeping your back straight and your head up, bend only at the waist to the right as far as possible. Breathe in as you bend to the side. Then hold for a second and come back up to the starting position as you exhale. Tip: Keep the rest of the body stationary.

Now repeat the movement but bending to the left instead. Hold for a second and come back to the starting position.

Repeat for the recommended amount of repetitions and then change hands.', 'Dumbbell_Side_Bend/0.jpg', 'Dumbbell_Side_Bend'),
  ('Dumbbell Squat', 'benen', false, 'beginner', 'Stand up straight while holding a dumbbell on each hand (palms facing the side of your legs).
...
Repeat for the recommended amount of repetitions.', 'Dumbbell_Squat/0.jpg', 'Dumbbell_Squat'),
  ('Dumbbell Squat To A Bench', 'benen', false, 'intermediate', 'Stand up straight with a flat bench behind you while holding a dumbbell on each hand (palms facing the side of your legs).
...
Repeat for the recommended amount of repetitions.', 'Dumbbell_Squat_To_A_Bench/0.jpg', 'Dumbbell_Squat_To_A_Bench'),
  ('Dumbbell Step Ups', 'benen', false, 'intermediate', 'Stand up straight while holding a dumbbell on each hand (palms facing the side of your legs).

Place the right foot on the elevated platform. Step on the platform by extending the hip and the knee of your right leg. Use the heel mainly to lift the rest of your body up and place the foot of the left leg on the platform as well. Breathe out as you execute the force required to come up.

Step down with the left leg by flexing the hip and knee of the right leg as you inhale. Return to the original standing position by placing the right foot of to next to the left foot on the initial position.

Repeat with the right leg for the recommended amount of repetitions and then perform with the left leg.', 'Dumbbell_Step_Ups/0.jpg', 'Dumbbell_Step_Ups'),
  ('Dumbbell Tricep Extension -Pronated Grip', 'armen', false, 'beginner', 'Lie down on a flat bench holding two dumbbells directly above your shoulders. Your arms should be fully extended and form a 90 degree angle from your torso and the floor.
...
Then, exhale and use your triceps to return the weight to the starting position.', 'Dumbbell_Tricep_Extension_-Pronated_Grip/0.jpg', 'Dumbbell_Tricep_Extension_-Pronated_Grip'),
  ('EZ-Bar Curl', 'armen', false, 'beginner', 'Stand up straight while holding an EZ curl bar at the wide outer handle. The palms of your hands should be facing forward and slightly tilted inward due to the shape of the bar. Keep your elbows close to your torso. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'EZ-Bar_Curl/0.jpg', 'EZ-Bar_Curl'),
  ('EZ-Bar Skullcrusher', 'armen', false, 'beginner', 'Using a close grip, lift the EZ bar and hold it with your elbows in as you lie on the bench. Your arms should be perpendicular to the floor. This will be your starting position.
...
Repeat.', 'EZ-Bar_Skullcrusher/0.jpg', 'EZ-Bar_Skullcrusher'),
  ('Elbow to Knee', 'core', false, 'beginner', 'Lie on the floor, crossing your right leg across your bent left knee. Clasp your hands behind your head, beginning with your shoulder blades on the ground. This will be your starting position.

Perform the motion by flexing the spine and rotating your torso to bring the left elbow to the right knee.

Return to the starting position and repeat the movement for the desired number of repetitions before switching sides.', 'Elbow_to_Knee/0.jpg', 'Elbow_to_Knee'),
  ('Elevated Back Lunge', 'benen', false, 'intermediate', 'Position a bar onto a rack at shoulder height loaded to an appropriate weight. Place a short, raised platform behind you.
...
Pause, and extend through the hips and knees to rise up, returning all the way to the starting position before alternating.', 'Elevated_Back_Lunge/0.jpg', 'Elevated_Back_Lunge'),
  ('Elevated Cable Rows', 'rug', false, 'intermediate', 'Get a platform of some sort (it can be an aerobics or calf raise platform) that is around 4-6 inches in height.
...
Repeat for the recommended amount of repetitions.', 'Elevated_Cable_Rows/0.jpg', 'Elevated_Cable_Rows'),
  ('Extended Range One-Arm Kettlebell Floor Press', 'borst', false, 'beginner', 'Lie on the floor and position a kettlebell for one arm to press. The kettlebell should be held by the handle. The leg on the same side that you are pressing should be bent, with the knee crossing over the midline of the body.

Press the kettlebell by extending the elbow and adducting the arm, pressing it above your body. Return to the starting position.', 'Extended_Range_One-Arm_Kettlebell_Floor_Press/0.jpg', 'Extended_Range_One-Arm_Kettlebell_Floor_Press'),
  ('External Rotation', 'schouders', false, 'beginner', 'Lie sideways on a flat bench with one arm holding a dumbbell and the other hand on top of the bench folded so that you can rest your head on it.
...
Repeat for the recommended amount of repetitions and then switch to the other arm.', 'External_Rotation/0.jpg', 'External_Rotation'),
  ('External Rotation with Cable', 'schouders', false, 'beginner', 'Adjust the cable to the same height as your elbow. Stand with your left side to the band a couple of feet away.
...
Execute the movement by rotating your arm in a backhand motion, keeping your elbow in place.', 'External_Rotation_with_Cable/0.jpg', 'External_Rotation_with_Cable'),
  ('Face Pull', 'schouders', false, 'intermediate', 'Facing a high pulley with a rope or dual handles attached, pull the weight directly towards your face, separating your hands as you do so. Keep your upper arms parallel to the ground.', 'Face_Pull/0.jpg', 'Face_Pull'),
  ('Finger Curls', 'armen', false, 'beginner', 'Hold a barbell with both hands and your palms facing up; hands spaced about shoulder width.
...
Now curl bar up as high as possible by closing your hands while exhaling. Hold the contraction at the top.', 'Finger_Curls/0.jpg', 'Finger_Curls'),
  ('Flat Bench Cable Flyes', 'borst', false, 'intermediate', 'Position a flat bench between two low pulleys so that when you are laying on it, your chest will be lined up with the cable pulleys.
...
Repeat for the recommended amount of repetitions.', 'Flat_Bench_Cable_Flyes/0.jpg', 'Flat_Bench_Cable_Flyes'),
  ('Flat Bench Leg Pull-In', 'core', false, 'beginner', 'Lie on an exercise mat or a flat bench with your legs off the end.
...
Repeat for the recommended amount of repetitions.', 'Flat_Bench_Leg_Pull-In/0.jpg', 'Flat_Bench_Leg_Pull-In'),
  ('Flat Bench Lying Leg Raise', 'core', false, 'beginner', 'Lie with your back flat on a bench and your legs extended in front of you off the end.
...
Now, as you inhale, slowly lower your legs back down to the starting position.', 'Flat_Bench_Lying_Leg_Raise/0.jpg', 'Flat_Bench_Lying_Leg_Raise'),
  ('Flexor Incline Dumbbell Curls', 'armen', false, 'beginner', 'Hold the dumbbell towards the side farther from you so that you have more weight on the side closest to you. (This can be done for a good effect on all bicep dumbbell exercises). Now do a normal incline dumbbell curl, but keep your wrists as far back as possible so as to neutralize any stress that is placed on them.
...
Repeat for the recommended amount of repetitions.', 'Flexor_Incline_Dumbbell_Curls/0.jpg', 'Flexor_Incline_Dumbbell_Curls'),
  ('Flutter Kicks', 'benen', false, 'beginner', 'On a flat bench lie facedown with the hips on the edge of the bench, the legs straight with toes high off the floor and with the arms on top of the bench holding on to the front edge.
...
Continue alternating in this manner (as though you are doing a flutter kick in water) until you have done the recommended amount of repetitions for each leg. Make sure that you keep a controlled movement at all times. Tip: You will breathe normally as you perform this movement.', 'Flutter_Kicks/0.jpg', 'Flutter_Kicks'),
  ('Freehand Jump Squat', 'benen', false, 'intermediate', 'Cross your arms over your chest.
...
Repeat for the recommended amount of repetitions.', 'Freehand_Jump_Squat/0.jpg', 'Freehand_Jump_Squat'),
  ('Frog Sit-Ups', 'core', false, 'intermediate', 'Lie with your back flat on the floor (or exercise mat) and your legs extended in front of you.
...
Repeat for the recommended amount of repetitions.', 'Frog_Sit-Ups/0.jpg', 'Frog_Sit-Ups'),
  ('Front Barbell Squat', 'benen', false, 'expert', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, bring your arms up under the bar while keeping the elbows high and the upper arm slightly above parallel to the floor. Rest the bar on top of the deltoids and cross your arms while grasping the bar for total control.
...
Repeat for the recommended amount of repetitions.', 'Front_Barbell_Squat/0.jpg', 'Front_Barbell_Squat'),
  ('Front Barbell Squat To A Bench', 'benen', false, 'expert', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set a flat bench behind you and set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, bring your arms up under the bar while keeping the elbows high and the upper arm slightly above parallel to the floor. Rest the bar on top of the deltoids and cross your arms while grasping the bar for total control.
...
Repeat for the recommended amount of repetitions.', 'Front_Barbell_Squat_To_A_Bench/0.jpg', 'Front_Barbell_Squat_To_A_Bench'),
  ('Front Cable Raise', 'schouders', false, 'beginner', 'Select the weight on a low pulley machine and grasp the single hand cable attachment that is attached to the low pulley with your left hand.
...
Once all of the recommended amount of repetitions have been performed for this arm, switch arms and perform the exercise with the right one.', 'Front_Cable_Raise/0.jpg', 'Front_Cable_Raise'),
  ('Front Dumbbell Raise', 'schouders', false, 'beginner', 'Pick a couple of dumbbells and stand with a straight torso and the dumbbells on front of your thighs at arms length with the palms of the hand facing your thighs. This will be your starting position.
...
Continue alternating in this fashion until all of the recommended amount of repetitions have been performed for each arm.', 'Front_Dumbbell_Raise/0.jpg', 'Front_Dumbbell_Raise'),
  ('Front Incline Dumbbell Raise', 'schouders', false, 'beginner', 'Sit down on an incline bench with the incline set anywhere between 30 to 60 degrees while holding a dumbbell on each hand. Tip: You can change the angle to hit the muscle a little differently each time.
...
Repeat for the recommended amount of repetitions.', 'Front_Incline_Dumbbell_Raise/0.jpg', 'Front_Incline_Dumbbell_Raise'),
  ('Front Raise And Pullover', 'borst', false, 'beginner', 'Lie on a flat bench while holding a barbell using a palms down grip that is about 15 inches apart.
...
Repeat for the recommended amount of repetitions.', 'Front_Raise_And_Pullover/0.jpg', 'Front_Raise_And_Pullover'),
  ('Front Squat (Clean Grip)', 'benen', false, 'intermediate', 'To begin, first set the bar in a rack slightly below shoulder level. Rest the bar on top of the deltoids, pushing into the clavicles, and lightly touching the throat. Your hands should be in a clean grip, touching the bar only with your fingers to help keep it in position.
...
Begin to raise the bar as you exhale by pushing the floor mainly with the heel or middle of your foot as you straighten the legs again and return to the starting position.', 'Front_Squat_Clean_Grip/0.jpg', 'Front_Squat_Clean_Grip'),
  ('Front Squats With Two Kettlebells', 'benen', false, 'intermediate', 'Clean two kettlebells to your shoulders. Clean the kettlebells to your shoulders by extending through the legs and hips as you pull the kettlebells towards your shoulders. Rotate your wrists as you do so.
...
Rise back up by driving through your heels and repeat.', 'Front_Squats_With_Two_Kettlebells/0.jpg', 'Front_Squats_With_Two_Kettlebells'),
  ('Front Two-Dumbbell Raise', 'schouders', false, 'beginner', 'Pick a couple of dumbbells and stand with a straight torso and the dumbbells on front of your thighs at arms length with the palms of the hand facing your thighs. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Front_Two-Dumbbell_Raise/0.jpg', 'Front_Two-Dumbbell_Raise'),
  ('Full Range-Of-Motion Lat Pulldown', 'rug', false, 'intermediate', 'Either standing or seated on a high bench, grasp two stirrup cables that are attached to the high pulleys. Grab with the opposing hand so your arms are crisscrossed about you and your palms are facing forward.
...
Keeping your chest up and maintaining a slight arch in your lower back, pull the handles down as if you were doing a regular pulldown. The range of motion will be more of an arc. During the movement, rotate your hands so that in the bottom position your palms face each other rather than forward. Return slowly to the starting position and repeat.', 'Full_Range-Of-Motion_Lat_Pulldown/0.jpg', 'Full_Range-Of-Motion_Lat_Pulldown'),
  ('Glute Kickback', 'benen', false, 'beginner', 'Kneel on the floor or an exercise mat and bend at the waist with your arms extended in front of you (perpendicular to the torso) in order to get into a kneeling push-up position but with the arms spaced at shoulder width. Your head should be looking forward and the bend of the knees should create a 90-degree angle between the hamstrings and the calves. This will be your starting position.
...
Continue to alternate legs until all of the recommended repetitions have been performed.', 'Glute_Kickback/0.jpg', 'Glute_Kickback'),
  ('Goblet Squat', 'benen', false, 'beginner', 'Stand holding a light kettlebell by the horns close to your chest. This will be your starting position.

Squat down between your legs until your hamstrings are on your calves. Keep your chest and head up and your back straight.

At the bottom position, pause and use your elbows to push your knees out. Return to the starting position, and repeat for 10-20 repetitions.', 'Goblet_Squat/0.jpg', 'Goblet_Squat'),
  ('Gorilla Chin/Crunch', 'core', false, 'intermediate', 'Hang from a chin-up bar using an underhand grip (palms facing you) that is slightly wider than shoulder width.
...
Repeat for the recommended amount of repetitions.', 'Gorilla_Chin_Crunch/0.jpg', 'Gorilla_Chin_Crunch'),
  ('Hack Squat', 'benen', false, 'beginner', 'Place the back of your torso against the back pad of the machine and hook your shoulders under the shoulder pads provided.
...
Repeat for the recommended amount of repetitions.', 'Hack_Squat/0.jpg', 'Hack_Squat'),
  ('Hammer Curls', 'armen', false, 'beginner', 'Stand up with your torso upright and a dumbbell on each hand being held at arms length. The elbows should be close to the torso.
...
Repeat for the recommended amount of repetitions.', 'Hammer_Curls/0.jpg', 'Hammer_Curls'),
  ('Hammer Grip Incline DB Bench Press', 'borst', false, 'beginner', 'Lie back on an incline bench with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.
...
When you are done, place the dumbbells back in your thighs and then on the floor. This is the safest manner to dispose of the dumbbells.', 'Hammer_Grip_Incline_DB_Bench_Press/0.jpg', 'Hammer_Grip_Incline_DB_Bench_Press'),
  ('Handstand Push-Ups', 'schouders', false, 'expert', 'With your back to the wall bend at the waist and place both hands on the floor at shoulder width.
...
Repeat for the recommended amount of repetitions.', 'Handstand_Push-Ups/0.jpg', 'Handstand_Push-Ups'),
  ('Hanging Leg Raise', 'core', false, 'expert', 'Hang from a chin-up bar with both arms extended at arms length in top of you using either a wide grip or a medium grip. The legs should be straight down with the pelvis rolled slightly backwards. This will be your starting position.

Raise your legs until the torso makes a 90-degree angle with the legs. Exhale as you perform this movement and hold the contraction for a second or so.

Go back slowly to the starting position as you breathe in.

Repeat for the recommended amount of repetitions.', 'Hanging_Leg_Raise/0.jpg', 'Hanging_Leg_Raise'),
  ('Hanging Pike', 'core', false, 'expert', 'Hang from a chin-up bar with your legs and feet together using an overhand grip (palms facing away from you) that is slightly wider than shoulder width. Tip: You may use wrist wraps in order to facilitate holding on to the bar.
...
Repeat for the recommended amount of repetitions.', 'Hanging_Pike/0.jpg', 'Hanging_Pike'),
  ('High Cable Curls', 'armen', false, 'intermediate', 'Stand between a couple of high pulleys and grab a handle in each arm. Position your upper arms in a way that they are parallel to the floor with the palms of your hands facing you. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Hyperextensions_With_No_Hyperextension_Bench/0.jpg', 'Hyperextensions_With_No_Hyperextension_Bench'),
  ('Incline Barbell Triceps Extension', 'armen', false, 'intermediate', 'Hold a barbell with an overhand grip (palms down) that is a little closer together than shoulder width.
...
Repeat for the recommended amount of repetitions.', 'Incline_Barbell_Triceps_Extension/0.jpg', 'Incline_Barbell_Triceps_Extension'),
  ('Incline Bench Pull', 'rug', false, 'beginner', 'Grab a dumbbell in each hand and lie face down on an incline bench that is set to an incline that is approximately 30 degrees.
...
Repeat for the recommended amount of repetitions.', 'Incline_Bench_Pull/0.jpg', 'Incline_Bench_Pull'),
  ('Incline Cable Chest Press', 'borst', false, 'beginner', 'Adjust the weight to an appropriate amount and be seated, grasping the handles. Your upper arms should be about 45 degrees to the body, with your head and chest up. The elbows should be bent to about 90 degrees. This will be your starting position.

Begin by extending through the elbow, pressing the handles together straight in front of you. Keep your shoulder blades retracted as you execute the movement.

After pausing at full extension, return to the starting position, keeping tension on the cables.', 'Incline_Cable_Chest_Press/0.jpg', 'Incline_Cable_Chest_Press'),
  ('Incline Cable Flye', 'borst', false, 'intermediate', 'To get yourself into the starting position, set the pulleys at the floor level (lowest level possible on the machine that is below your torso).
...
Repeat the movement for the prescribed amount of repetitions.', 'Incline_Cable_Flye/0.jpg', 'Incline_Cable_Flye'),
  ('Incline Dumbbell Bench With Palms Facing In', 'borst', false, 'beginner', 'Lie back on an incline bench with a dumbbell on each hand on top of your thighs. The palms of your hand will be facing each other.
...
When you are done, place the dumbbells back in your thighs and then on the floor. This is the safest manner to dispose of the dumbbells.', 'Incline_Dumbbell_Bench_With_Palms_Facing_In/0.jpg', 'Incline_Dumbbell_Bench_With_Palms_Facing_In'),
  ('Incline Dumbbell Curl', 'armen', false, 'beginner', 'Sit back on an incline bench with a dumbbell in each hand held at arms length. Keep your elbows close to your torso and rotate the palms of your hands until they are facing forward. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Incline_Dumbbell_Curl/0.jpg', 'Incline_Dumbbell_Curl'),
  ('Incline Dumbbell Flyes', 'borst', false, 'beginner', 'Hold a dumbbell on each hand and lie on an incline bench that is set to an incline angle of no more than 30 degrees.
...
Repeat for the recommended amount of repetitions.', 'Incline_Dumbbell_Flyes/0.jpg', 'Incline_Dumbbell_Flyes'),
  ('Incline Dumbbell Flyes - With A Twist', 'borst', false, 'beginner', 'Hold a dumbbell in each hand and lie on an incline bench that is set to an incline angle of no more than 30 degrees.
...
Repeat for the recommended amount of repetitions.', 'Incline_Dumbbell_Flyes_-_With_A_Twist/0.jpg', 'Incline_Dumbbell_Flyes_-_With_A_Twist'),
  ('Incline Dumbbell Press', 'borst', false, 'beginner', 'Lie back on an incline bench with a dumbbell in each hand atop your thighs. The palms of your hands will be facing each other.
...
When you are done, place the dumbbells back on your thighs and then on the floor. This is the safest manner to release the dumbbells.', 'Incline_Dumbbell_Press/0.jpg', 'Incline_Dumbbell_Press'),
  ('Incline Hammer Curls', 'armen', false, 'beginner', 'Seat yourself on an incline bench with a dumbbell in each hand. You should pressed firmly against he back with your feet together. Allow the dumbbells to hang straight down at your side, holding them with a neutral grip. This will be your starting position.

Initiate the movement by flexing at the elbow, attempting to keep the upper arm stationary.

Continue to the top of the movement and pause, then slowly return to the start position.', 'Incline_Hammer_Curls/0.jpg', 'Incline_Hammer_Curls'),
  ('Incline Inner Biceps Curl', 'armen', false, 'beginner', 'Hold a dumbbell in each hand and lie back on an incline bench.
...
Repeat for the recommended amount of repetitions.', 'Incline_Inner_Biceps_Curl/0.jpg', 'Incline_Inner_Biceps_Curl'),
  ('Incline Push-Up', 'borst', false, 'beginner', 'Stand facing bench or sturdy elevated platform. Place hands on edge of bench or platform, slightly wider than shoulder width.
...
Push body up until arms are extended. Repeat.', 'Incline_Push-Up/0.jpg', 'Incline_Push-Up'),
  ('Incline Push-Up Close-Grip', 'armen', false, 'beginner', 'Stand facing a Smith machine bar or sturdy elevated platform at an appropriate height.
...
Return to the starting position by extending the elbows, pressing yourself back up.', 'Incline_Push-Up_Close-Grip/0.jpg', 'Incline_Push-Up_Close-Grip'),
  ('Incline Push-Up Medium', 'borst', false, 'beginner', 'Stand facing a Smith machine bar or sturdy elevated platform at an appropriate height.
...
Return to the starting position by extending the elbows, pressing yourself back up.', 'Incline_Push-Up_Medium/0.jpg', 'Incline_Push-Up_Medium'),
  ('Incline Push-Up Reverse Grip', 'borst', false, 'beginner', 'Stand facing a Smith machine bar or sturdy elevated platform at an appropriate height.
...
Return to the starting position by extending the elbows, pressing yourself back up.', 'Incline_Push-Up_Reverse_Grip/0.jpg', 'Incline_Push-Up_Reverse_Grip'),
  ('Incline Push-Up Wide', 'borst', false, 'beginner', 'Stand facing a Smith machine bar or sturdy elevated platform at an appropriate height.
...
Return to the starting position by extending the elbows, pressing yourself back up.', 'Incline_Push-Up_Wide/0.jpg', 'Incline_Push-Up_Wide'),
  ('Iron Cross', 'schouders', false, 'intermediate', null, 'Iron_Cross/0.jpg', 'Iron_Cross'),
  ('Isometric Neck Exercise - Front And Back', 'schouders', false, 'beginner', 'With your head and neck in a neutral position (normal position with head erect facing forward), place both of your hands on the front side of your head.
...
Rest for the recommended amount of time and repeat with your hands placed on the back side of your head.', 'Isometric_Neck_Exercise_-_Front_And_Back/0.jpg', 'Isometric_Neck_Exercise_-_Front_And_Back'),
  ('Isometric Neck Exercise - Sides', 'schouders', false, 'beginner', 'With your head and neck in a neutral position (normal position with head erect facing forward), place your left hand on the left side of your head.
...
Rest for the recommended amount of time and repeat with your right hand placed on the right side of your head.', 'Isometric_Neck_Exercise_-_Sides/0.jpg', 'Isometric_Neck_Exercise_-_Sides'),
  ('Isometric Wipers', 'borst', false, 'beginner', 'Assume a push-up position, supporting your weight on your hands and toes while keeping your body straight. Your hands should be just outside of shoulder width. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'JM_Press/0.jpg', 'JM_Press'),
  ('Jackknife Sit-Up', 'core', false, 'beginner', 'Lie flat on the floor (or exercise mat) on your back with your arms extended straight back behind your head and your legs extended also. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Jackknife_Sit-Up/0.jpg', 'Jackknife_Sit-Up'),
  ('Janda Sit-Up', 'core', false, 'beginner', 'Position your body on the floor in the basic sit-up position; knees to a ninety degree angle with feet flat on the floor and arms either crossed over your chest or to the sides. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Janda_Sit-Up/0.jpg', 'Janda_Sit-Up'),
  ('Jefferson Squats', 'benen', false, 'intermediate', 'Place a barbell on the floor.
...
Now drive yourself back up to the starting position by pushing with the feet . Tip: Keep the bar hanging at arm''s length and your elbows locked with a slight bend. The arms only serve as hooks. Avoid doing any lifting with them. Do the lifting with your thighs; not your arms.', 'Jefferson_Squats/0.jpg', 'Jefferson_Squats'),
  ('Kettlebell Arnold Press', 'schouders', false, 'intermediate', 'Clean a kettlebell to your shoulder. Clean the kettlebell to your shoulder by extending through the legs and hips as you raise the kettlebell towards your shoulder. The palm should be facing inward.
...
Return the kettlebell to the starting position, with the palm facing in.', 'Kettlebell_Arnold_Press/0.jpg', 'Kettlebell_Arnold_Press'),
  ('Kettlebell Dead Clean', 'benen', false, 'intermediate', 'Place kettlebell between your feet. To get in the starting position, push your butt back and look straight ahead.
...
Lower the kettlebell, keeping the hamstrings loaded by keeping your back straight and your butt out.', 'Kettlebell_Dead_Clean/0.jpg', 'Kettlebell_Dead_Clean'),
  ('Kettlebell Figure 8', 'core', false, 'intermediate', 'Place one kettlebell between your legs and take a wider than shoulder width stance. Bend over by pushing your butt out and keeping your back flat.

Pick up a kettlebell and pass it to your other hand between your legs. The receiving hand should reach from behind the legs. Go back and forth for several repetitions.', 'Kettlebell_Figure_8/0.jpg', 'Kettlebell_Figure_8'),
  ('Kettlebell Hang Clean', 'benen', false, 'intermediate', 'Place kettlebell between your feet. To get in the starting position, push your butt back and look straight ahead.
...
Lower kettlebell to a hanging position between your legs while keeping the hamstrings loaded. Keep your head up at all times.', 'Kettlebell_Hang_Clean/0.jpg', 'Kettlebell_Hang_Clean'),
  ('Kettlebell One-Legged Deadlift', 'benen', false, 'intermediate', 'Hold a kettlebell by the handle in one hand. Stand on one leg, on the same side that you hold the kettlebell.
...
Continue lowering the kettlebell until you are parallel to the ground, and then return to the upright position.', 'Kettlebell_One-Legged_Deadlift/0.jpg', 'Kettlebell_One-Legged_Deadlift'),
  ('Kettlebell Pass Between The Legs', 'core', false, 'intermediate', 'Place one kettlebell between your legs and take a comfortable stance. Bend over by pushing your butt out and keeping your back flat.

Pick up a kettlebell and pass it to your other hand between your legs, in the fashion of a "W". Go back and forth for several repetitions.', 'Kettlebell_Pass_Between_The_Legs/0.jpg', 'Kettlebell_Pass_Between_The_Legs'),
  ('Kettlebell Pirate Ships', 'schouders', false, 'beginner', 'With a wide stance, hold a kettlebell with both hands. Allow it to hang at waist level with your arms extended. This will be your starting position.
...
Repeat for the desired amount of repetitions.', 'Kettlebell_Pirate_Ships/0.jpg', 'Kettlebell_Pirate_Ships'),
  ('Kettlebell Pistol Squat', 'benen', false, 'expert', 'Pick up a kettlebell with two hands and hold it by the horns. Hold one leg off of the floor and squat down on the other.
...
Lower yourself again and repeat.', 'Kettlebell_Pistol_Squat/0.jpg', 'Kettlebell_Pistol_Squat'),
  ('Kettlebell Seated Press', 'schouders', false, 'intermediate', 'Sit on the floor and spread your legs out comfortably.

Clean one kettlebell to your shoulder.

Press the kettlebell up and out until it is locked out overhead. Return to the starting position.', 'Kettlebell_Seated_Press/0.jpg', 'Kettlebell_Seated_Press'),
  ('Kettlebell Seesaw Press', 'schouders', false, 'intermediate', 'Clean two kettlebells two your shoulders.

Press one kettlebell.

Lower the kettlebell and immediately press the other kettlebell. Make sure to do the same amount of reps on both sides.', 'Kettlebell_Seesaw_Press/0.jpg', 'Kettlebell_Seesaw_Press'),
  ('Kettlebell Sumo High Pull', 'rug', false, 'intermediate', 'Place a kettlebell on the ground between your feet. Position your feet in a wide stance, and grasp the kettlebell with two hands. Set your hips back as far as possible, with your knees bent. Keep your chest and head up. This will be your starting position.

Begin by extending the hips and knees, simultaneously pulling the kettlebell to your shoulders, raising your elbows as you do so. Reverse the motion to return to the starting position.', 'Kettlebell_Sumo_High_Pull/0.jpg', 'Kettlebell_Sumo_High_Pull'),
  ('Kettlebell Thruster', 'schouders', false, 'intermediate', 'Clean two kettlebells to your shoulders. Clean the kettlebells to your shoulders by extending through the legs and hips as you pull the kettlebells towards your shoulders. Rotate your wrists as you do so. This will be your starting position.
...
As you begin the next repetition, return the weights to the shoulders.', 'Kettlebell_Thruster/0.jpg', 'Kettlebell_Thruster'),
  ('Kettlebell Turkish Get-Up (Lunge style)', 'schouders', false, 'intermediate', 'Lie on your back on the floor and press a kettlebell to the top position by extending the elbow. Bend the knee on the same side as the kettlebell.
...
While looking up at the kettlebell, slowly stand up. Reverse the motion back to the starting position and repeat.', 'Kettlebell_Turkish_Get-Up_Lunge_style/0.jpg', 'Kettlebell_Turkish_Get-Up_Lunge_style'),
  ('Kettlebell Turkish Get-Up (Squat style)', 'schouders', false, 'intermediate', 'Lie on your back on the floor and press a kettlebell to the top position by extending the elbow. Bend the knee on the same side as the kettlebell.
...
Using your free hand, push yourself to a seated position, then progressing to your feet. While looking up at the kettlebell, slowly stand up. Reverse the motion back to the starting position and repeat.', 'Kettlebell_Turkish_Get-Up_Squat_style/0.jpg', 'Kettlebell_Turkish_Get-Up_Squat_style'),
  ('Kettlebell Windmill', 'core', false, 'intermediate', 'Place a kettlebell in front of your lead foot and clean and press it overhead with your opposite arm. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulders. Rotate your wrist as you do so, so that the palm faces forward. Press it overhead by extending the elbow.
...
Pause for a second after reaching the ground and reverse the motion back to the starting position.', 'Kettlebell_Windmill/0.jpg', 'Kettlebell_Windmill'),
  ('Kneeling Cable Crunch With Alternating Oblique Twists', 'core', false, 'beginner', 'Connect a rope attachment to a high pulley cable and position a mat on the floor in front of it.
...
Continue this series of movements to failure.', 'Kneeling_Cable_Crunch_With_Alternating_Oblique_Twists/0.jpg', 'Kneeling_Cable_Crunch_With_Alternating_Oblique_Twists'),
  ('Kneeling Cable Triceps Extension', 'armen', false, 'intermediate', 'Place a bench sideways in front of a high pulley machine.
...
Repeat for the recommended amount of repetitions.', 'Kneeling_Cable_Triceps_Extension/0.jpg', 'Kneeling_Cable_Triceps_Extension'),
  ('Kneeling High Pulley Row', 'rug', false, 'beginner', 'Select the appropriate weight using a pulley that is above your head. Attach a rope to the cable and kneel a couple of feet away, holding the rope out in front of you with both arms extended. This will be your starting position.
...
After pausing briefly, slowly return to the starting position.', 'Kneeling_High_Pulley_Row/0.jpg', 'Kneeling_High_Pulley_Row'),
  ('Kneeling Single-Arm High Pulley Row', 'rug', false, 'beginner', 'Attach a single handle to a high pulley and make your weight selection.
...
After a brief pause, return to the starting position.', 'Kneeling_Single-Arm_High_Pulley_Row/0.jpg', 'Kneeling_Single-Arm_High_Pulley_Row'),
  ('Landmine 180''s', 'core', false, 'beginner', 'Position a bar into a landmine or securely anchor it in a corner. Load the bar to an appropriate weight.
...
Continue alternating the movement until the set is complete.', 'Landmine_180s/0.jpg', 'Landmine_180s'),
  ('Landmine Linear Jammer', 'schouders', false, 'intermediate', 'Position a bar into landmine or, lacking one, securely anchor it in a corner. Load the bar to an appropriate weight and position the handle attachment on the bar.
...
Return to the starting position.', 'Landmine_Linear_Jammer/0.jpg', 'Landmine_Linear_Jammer'),
  ('Leg-Over Floor Press', 'borst', false, 'intermediate', 'Lie on the floor with one kettlebell in place on your chest, holding it by the handle. Extend leg on working side over leg on non-working side.Your free arm can be extended out to your side for support.

Press the kettlebll into a locked out position.

Lower the weight until the elbow touches the ground, keeping the kettlebell above the elbow. Repeat for the desired number of repetitions.', 'Leg-Over_Floor_Press/0.jpg', 'Leg-Over_Floor_Press'),
  ('Leg Extensions', 'benen', false, 'beginner', 'For this exercise you will need to use a leg extension machine. First choose your weight and sit on the machine with your legs under the pad (feet pointed forward) and the hands holding the side bars. This will be your starting position. Tip: You will need to adjust the pad so that it falls on top of your lower leg (just above your feet). Also, make sure that your legs form a 90-degree angle between the lower and upper leg. If the angle is less than 90-degrees then that means the knee is over the toes which in turn creates undue stress at the knee joint. If the machine is designed that way, either look for another machine or just make sure that when you start executing the exercise you stop going down once you hit the 90-degree angle.
...
Repeat for the recommended amount of times.', 'Leg_Extensions/0.jpg', 'Leg_Extensions'),
  ('Leg Lift', 'benen', false, 'beginner', 'While standing up straight with both feet next to each other at around shoulder width, grab a sturdy surface such as the sides of a squat rack or the top of a chair to brace yourself and keep balance.
...
Repeat the movement with the opposite leg.', 'Leg_Lift/0.jpg', 'Leg_Lift'),
  ('Leg Press', 'benen', false, 'beginner', 'Using a leg press machine, sit down on the machine and place your legs on the platform directly in front of you at a medium (shoulder width) foot stance. (Note: For the purposes of this discussion we will use the medium stance described above which targets overall development; however you can choose any of the three stances described in the foot positioning section).
...
Repeat for the recommended amount of repetitions and ensure to lock the safety pins properly once you are done. You do not want that platform falling on you fully loaded.', 'Leg_Press/0.jpg', 'Leg_Press'),
  ('Leg Pull-In', 'core', false, 'beginner', 'Lie on an exercise mat with your legs extended and your hands either palms facing down next to you or under your glutes. Tip: My preference is with the hands next to me. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Leg_Pull-In/0.jpg', 'Leg_Pull-In'),
  ('Leverage Chest Press', 'borst', false, 'beginner', 'Load an appropriate weight onto the pins and adjust the seat for your height. The handles should be near the bottom or middle of the pectorals at the beginning of the motion.
...
After a brief pause at the top, return the weight just above the start position, keeping tension on the muscles by not returning the weight to the stops until the set is complete.', 'Leverage_Chest_Press/0.jpg', 'Leverage_Chest_Press'),
  ('Leverage Deadlift', 'benen', false, 'beginner', 'Load the pins to an appropriate weight. Position yourself directly between the handles. Grasp the bottom handles with a comfortable grip, and then lower your hips as you take a breath. Look forward with your head and keep your chest up. This will be your starting position.

Return the weight to the starting position.', 'Leverage_Deadlift/0.jpg', 'Leverage_Deadlift'),
  ('Leverage Decline Chest Press', 'borst', false, 'beginner', 'Load an appropriate weight onto the pins and adjust the seat for your height. The handles should be near the bottom of the pectorals at the beginning of the motion. Your chest and head should be up and your shoulder blades retracted. This will be your starting position.

Press the handles forward by extending through the elbow.

After a brief pause at the top, return the weight just above the start position, keeping tension on the muscles by not returning the weight to the stops until the set is complete.', 'Leverage_Decline_Chest_Press/0.jpg', 'Leverage_Decline_Chest_Press'),
  ('Leverage High Row', 'rug', false, 'beginner', 'Load an appropriate weight onto the pins and adjust the seat height so that you can just reach the handles above you. Adjust the knee pad to help keep you down. Grasp the handles with a pronated grip. This will be your starting position.
...
For multiple repetitions, avoid completely returning the weight to the stops to keep tension on the muscles being worked.', 'Leverage_High_Row/0.jpg', 'Leverage_High_Row'),
  ('Leverage Incline Chest Press', 'borst', false, 'beginner', 'Load an appropriate weight onto the pins and adjust the seat for your height. The handles should be near the top of the pectorals at the beginning of the motion. Your chest and head should be up and your shoulder blades retracted. This will be your starting position.

Press the handles forward by extending through the elbow.

After a brief pause at the top, return the weight just above the start position, keeping tension on the muscles by not returning the weight to the stops until the set is complete.', 'Leverage_Incline_Chest_Press/0.jpg', 'Leverage_Incline_Chest_Press'),
  ('Leverage Iso Row', 'rug', false, 'beginner', 'Load an appropriate weight onto the pins and adjust the seat height so that the handles are at chest level. Grasp the handles with either a neutral or pronated grip. This will be your starting position.

Pull the handles towards your torso, retracting your shoulder blades as you flex the elbow.

Pause at the bottom of the motion, and then slowly return the handles to the starting position. For multiple repetitions, avoid completely returning the weight to the stops to keep tension on the muscles being worked.', 'Leverage_Iso_Row/0.jpg', 'Leverage_Iso_Row'),
  ('Leverage Shoulder Press', 'schouders', false, 'beginner', 'Load an appropriate weight onto the pins and adjust the seat for your height. The handles should be near the top of the shoulders at the beginning of the motion. Your chest and head should be up and handles held with a pronated grip. This will be your starting position.

Press the handles upward by extending through the elbow.

After a brief pause at the top, return the weight to just above the start position, keeping tension on the muscles by not returning the weight to the stops until the set is complete.', 'Leverage_Shoulder_Press/0.jpg', 'Leverage_Shoulder_Press'),
  ('Leverage Shrug', 'rug', false, 'beginner', 'Load the pins to an appropriate weight. Position yourself directly between the handles.
...
Pause at the top of the motion, and then return the weight to the starting position.', 'Leverage_Shrug/0.jpg', 'Leverage_Shrug'),
  ('Low Cable Crossover', 'borst', false, 'beginner', 'To move into the starting position, place the pulleys at the low position, select the resistance to be used and grasp a handle in each hand.
...
Return your arms back to the starting position after a brief pause.', 'Low_Cable_Crossover/0.jpg', 'Low_Cable_Crossover'),
  ('Low Cable Triceps Extension', 'armen', false, 'beginner', 'Select the desired weight and lay down face up on the bench of a seated row machine that has a rope attached to it. Your head should be pointing towards the attachment.
...
Repeat for the recommended amount of repetitions.', 'Low_Cable_Triceps_Extension/0.jpg', 'Low_Cable_Triceps_Extension'),
  ('Low Pulley Row To Neck', 'schouders', false, 'beginner', 'Sit on a low pulley row machine with a rope attachment.
...
Repeat for the recommended amount of repetitions.', 'Low_Pulley_Row_To_Neck/0.jpg', 'Low_Pulley_Row_To_Neck'),
  ('Lunge Pass Through', 'benen', false, 'intermediate', 'Stand with your torso upright holding a kettlebell in your right hand. This will be your starting position.
...
Repeat the movement for the recommended amount of repetitions, alternating legs.', 'Lunge_Pass_Through/0.jpg', 'Lunge_Pass_Through'),
  ('Lunge Sprint', 'benen', false, 'intermediate', 'Adjust a bar in a Smith machine to an appropriate height. Position yourself under the bar, racking it across the back of your shoulders. Unrack the bar, and then split your feet, moving one foot forward and one foot back. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Lunge_Sprint/0.jpg', 'Lunge_Sprint'),
  ('Lying Cable Curl', 'armen', false, 'intermediate', 'Grab a straight bar or E-Z bar attachment that is attached to the low pulley with both hands, using an underhand (palms facing up) shoulder-width grip.
...
Repeat for the recommended amount of repetitions.', 'Lying_Cable_Curl/0.jpg', 'Lying_Cable_Curl'),
  ('Lying Cambered Barbell Row', 'rug', false, 'beginner', 'Place a cambered bar underneath an exercise bench.
...
After a second hold at the top, lower back down to the starting position slowly as you inhale.', 'Lying_Cambered_Barbell_Row/0.jpg', 'Lying_Cambered_Barbell_Row'),
  ('Lying Close-Grip Bar Curl On High Pulley', 'armen', false, 'beginner', 'Place a flat bench in front of a high pulley or lat pulldown machine.
...
Repeat for the recommended amount of repetitions.', 'Lying_Close-Grip_Bar_Curl_On_High_Pulley/0.jpg', 'Lying_Close-Grip_Bar_Curl_On_High_Pulley'),
  ('Lying Close-Grip Barbell Triceps Extension Behind The Head', 'armen', false, 'intermediate', 'While holding a barbell or EZ Curl bar with a pronated grip (palms facing forward), lie on your back on a flat bench with your head close to the end of the bench. Tip: If you are holding a barbell grab it using a shoulder-width grip and if you are using an E-Z Bar grab it on the inner handles.
...
Repeat for the recommended amount of repetitions.', 'Lying_Close-Grip_Barbell_Triceps_Extension_Behind_The_Head/0.jpg', 'Lying_Close-Grip_Barbell_Triceps_Extension_Behind_The_Head'),
  ('Lying Close-Grip Barbell Triceps Press To Chin', 'armen', false, 'intermediate', 'While holding a barbell or EZ Curl bar with a pronated grip (palms facing forward), lie on your back on a flat bench with your head off the end of the bench. Tip: If you are holding a barbell grab it using a shoulder-width grip and if you are using an E-Z Bar grab it on the inner handles.
...
Repeat for the recommended amount of repetitions.', 'Lying_Close-Grip_Barbell_Triceps_Press_To_Chin/0.jpg', 'Lying_Close-Grip_Barbell_Triceps_Press_To_Chin'),
  ('Lying Dumbbell Tricep Extension', 'armen', false, 'intermediate', 'Lie on a flat bench while holding two dumbbells directly in front of you. Your arms should be fully extended at a 90-degree angle from your torso and the floor. The palms should be facing in and the elbows should be tucked in. This is the starting position.
...
Repeat for the recommended amount of repetitions.', 'Lying_Dumbbell_Tricep_Extension/0.jpg', 'Lying_Dumbbell_Tricep_Extension'),
  ('Lying High Bench Barbell Curl', 'armen', false, 'intermediate', 'Lie face forward on a tall flat bench while holding a barbell with a supinated grip (palms facing up). Tip: If you are holding a barbell grab it using a shoulder-width grip and if you are using an E-Z Bar grab it on the inner handles. Your upper body should be positioned in a way that the upper chest is over the end of the bench and the barbell is hanging in front of you with the arms extended and perpendicular to the floor. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Lying_High_Bench_Barbell_Curl/0.jpg', 'Lying_High_Bench_Barbell_Curl'),
  ('Lying Leg Curls', 'benen', false, 'beginner', 'Adjust the machine lever to fit your height and lie face down on the leg curl machine with the pad of the lever on the back of your legs (just a few inches under the calves). Tip: Preferably use a leg curl machine that is angled as opposed to flat since an angled position is more favorable for hamstrings recruitment.
...
As you inhale, bring the legs back to the initial position. Repeat for the recommended amount of repetitions.', 'Lying_Leg_Curls/0.jpg', 'Lying_Leg_Curls'),
  ('Lying Machine Squat', 'benen', false, 'intermediate', 'Adjust the leg machine to a height that will allow you to get inside it with your knees bent and the thighs slightly below parallel.
...
Repeat for the recommended amount of repetitions.', 'Lying_Machine_Squat/0.jpg', 'Lying_Machine_Squat'),
  ('Lying One-Arm Lateral Raise', 'schouders', false, 'intermediate', 'While holding a dumbbell in one hand, lay with your chest down on a flat bench. The other hand can be used to hold to the leg of the bench for stability.
...
Repeat for the recommended amount of repetitions.', 'Lying_One-Arm_Lateral_Raise/0.jpg', 'Lying_One-Arm_Lateral_Raise'),
  ('Lying Rear Delt Raise', 'schouders', false, 'intermediate', 'While holding a dumbbell in each hand, lay with your chest down on a flat bench.
...
Repeat for the recommended amount of repetitions and then switch to the other arm.', 'Lying_Rear_Delt_Raise/0.jpg', 'Lying_Rear_Delt_Raise'),
  ('Lying Supine Dumbbell Curl', 'armen', false, 'beginner', 'Lie down on a flat bench face up while holding a dumbbell in each arm on top of your thighs.
...
Return back to the starting position very slowly.', 'Lying_Supine_Dumbbell_Curl/0.jpg', 'Lying_Supine_Dumbbell_Curl'),
  ('Lying T-Bar Row', 'rug', false, 'intermediate', 'Load up the T-bar Row Machine with the desired weight and adjust the leg height so that your upper chest is at the top of the pad. Tip: In some machines all you can do is stand on the appropriate step that allows you to be at a height that has the upper chest at the top of the pad.
...
Repeat for the recommended amount of repetitions.', 'Lying_T-Bar_Row/0.jpg', 'Lying_T-Bar_Row'),
  ('Lying Triceps Press', 'armen', false, 'intermediate', 'Lie on a flat bench with either an e-z bar (my preference) or a straight bar placed on the floor behind your head and your feet on the floor.
...
Repeat for the recommended amount of repetitions.', 'Lying_Triceps_Press/0.jpg', 'Lying_Triceps_Press'),
  ('Machine Bench Press', 'borst', false, 'beginner', 'Sit down on the Chest Press Machine and select the weight.
...
When finished step on the lever again and slowly get the handles back to their original place.', 'Machine_Bench_Press/0.jpg', 'Machine_Bench_Press'),
  ('Machine Bicep Curl', 'armen', false, 'beginner', 'Adjust the seat to the appropriate height and make your weight selection. Place your upper arms against the pads and grasp the handles. This will be your starting position.
...
Avoid returning the weight all the way to the stops until the set is complete to keep tension on the muscles being worked.', 'Machine_Bicep_Curl/0.jpg', 'Machine_Bicep_Curl'),
  ('Machine Preacher Curls', 'armen', false, 'beginner', 'Sit down on the Preacher Curl Machine and select the weight.
...
Repeat for the recommended amount of repetitions.', 'Machine_Preacher_Curls/0.jpg', 'Machine_Preacher_Curls'),
  ('Machine Shoulder (Military) Press', 'schouders', false, 'beginner', 'Sit down on the Shoulder Press Machine and select the weight.
...
Repeat for the recommended amount of repetitions.', 'Machine_Shoulder_Military_Press/0.jpg', 'Machine_Shoulder_Military_Press'),
  ('Machine Triceps Extension', 'armen', false, 'beginner', 'Adjust the seat to the appropriate height and make your weight selection. Place your upper arms against the pads and grasp the handles. This will be your starting position.
...
Avoid returning the weight all the way to the stops until the set is complete to keep tension on the muscles being worked.', 'Machine_Triceps_Extension/0.jpg', 'Machine_Triceps_Extension'),
  ('Middle Back Shrug', 'rug', false, 'intermediate', 'Lie facedown on an incline bench while holding a dumbbell in each hand. Your arms should be fully extended hanging down and pointing towards the floor. The palms of your hands should be facing each other. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Middle_Back_Shrug/0.jpg', 'Middle_Back_Shrug'),
  ('Narrow Stance Hack Squats', 'benen', false, 'intermediate', 'Place the back of your torso against the back pad of the machine and hook your shoulders under the shoulder pads provided.
...
Repeat for the recommended amount of repetitions and ensure to lock the safety pins properly once you are done. You do not want that platform falling on you fully loaded.', 'Narrow_Stance_Leg_Press/0.jpg', 'Narrow_Stance_Leg_Press'),
  ('Narrow Stance Squats', 'benen', false, 'intermediate', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Repeat for the recommended amount of repetitions.', 'Narrow_Stance_Squats/0.jpg', 'Narrow_Stance_Squats'),
  ('Natural Glute Ham Raise', 'benen', false, 'intermediate', 'Using the leg pad of a lat pulldown machine or a preacher bench, position yourself so that your ankles are under the pads, knees on the seat, and you are facing away from the machine. You should be upright and maintaining good posture.
...
If you are unable to complete a rep, use a band, a partner, or push off of a box to aid in completing a repetition.', 'Natural_Glute_Ham_Raise/0.jpg', 'Natural_Glute_Ham_Raise'),
  ('Neck Press', 'borst', false, 'intermediate', 'Lie back on a flat bench. Using a medium-width grip (a grip that creates a 90-degree angle in the middle of the movement between the forearms and the upper arms), lift the bar from the rack and hold it straight over your neck with your arms locked. This will be your starting position.
...
When you are done, place the bar back in the rack.', 'Neck_Press/0.jpg', 'Neck_Press'),
  ('Oblique Crunches', 'core', false, 'beginner', 'Lie flat on the floor with your lower back pressed to the ground. For this exercise, you will need to put one hand beside your head and the other to the side against the floor.
...
Continue alternating in this manner until all of the recommended repetitions for each side have been completed.', 'Oblique_Crunches/0.jpg', 'Oblique_Crunches'),
  ('Oblique Crunches - On The Floor', 'core', false, 'beginner', 'Start out by lying on your right side with your legs lying on top of each other. Make sure your knees are bent a little bit.
...
Remember to breathe in during the eccentric (lowering) part of the exercise and to breathe out during the concentric (elevation) part of the exercise.', 'Oblique_Crunches_-_On_The_Floor/0.jpg', 'Oblique_Crunches_-_On_The_Floor'),
  ('One-Arm Dumbbell Row', 'rug', false, 'beginner', 'Choose a flat bench and place a dumbbell on each side of it.
...
Switch sides and repeat again with the other arm.', 'One-Arm_Dumbbell_Row/0.jpg', 'One-Arm_Dumbbell_Row'),
  ('One-Arm Flat Bench Dumbbell Flye', 'borst', false, 'beginner', 'Lie down on a flat bench with a dumbbell in one hand resting on top of your thigh. The palm of your hand with the dumbbell in it should be at a neutral grip.
...
Switch arms and repeat the exercise.', 'One-Arm_Flat_Bench_Dumbbell_Flye/0.jpg', 'One-Arm_Flat_Bench_Dumbbell_Flye'),
  ('One-Arm High-Pulley Cable Side Bends', 'core', false, 'beginner', 'Connect a standard handle to a tower. Move cable to highest pulley position.
...
Then, reposition and repeat the same series of movements on the opposite side.', 'One-Arm_High-Pulley_Cable_Side_Bends/0.jpg', 'One-Arm_High-Pulley_Cable_Side_Bends'),
  ('One-Arm Incline Lateral Raise', 'schouders', false, 'beginner', 'Lie down sideways on an incline bench press with a dumbbell in the hand. Make sure the shoulder is pressing against the incline bench and the arm is lying across your body with the palm around your navel.
...
Switch arms and repeat the movement.', 'One-Arm_Incline_Lateral_Raise/0.jpg', 'One-Arm_Incline_Lateral_Raise'),
  ('One-Arm Kettlebell Clean', 'benen', false, 'intermediate', 'Place a kettlebell between your feet. As you bend down to grab the kettlebell, push your butt back and keep your eyes looking forward.
...
Return the weight to the starting position.', 'One-Arm_Kettlebell_Clean/0.jpg', 'One-Arm_Kettlebell_Clean'),
  ('One-Arm Kettlebell Clean and Jerk', 'schouders', false, 'intermediate', 'Hold a kettlebell by the handle.
...
Keeping the weight overhead, return to a standing position. Lower the weight to the floor to perform the next repetition.', 'One-Arm_Kettlebell_Clean_and_Jerk/0.jpg', 'One-Arm_Kettlebell_Clean_and_Jerk'),
  ('One-Arm Kettlebell Floor Press', 'borst', false, 'intermediate', 'Lie on the floor holding a kettlebell with one hand, with your upper arm supported by the floor. The palm should be facing in.

Press the kettlebell straight up toward the ceiling, rotating your wrist.

Lower the kettlebell back to the starting position and repeat.', 'One-Arm_Kettlebell_Floor_Press/0.jpg', 'One-Arm_Kettlebell_Floor_Press'),
  ('One-Arm Kettlebell Jerk', 'schouders', false, 'intermediate', 'Hold a kettlebell by the handle. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulder. Rotate your wrist as you do so, so that the palm faces forward. This will be your starting position.
...
Lower the weight to perform the next repetition.', 'One-Arm_Kettlebell_Jerk/0.jpg', 'One-Arm_Kettlebell_Jerk'),
  ('One-Arm Kettlebell Military Press To The Side', 'schouders', false, 'intermediate', 'Clean a kettlebell to your shoulder. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulder. Rotate your wrist as you do so, so that the palm faces inward. This will be your starting position.

Look at the kettlebell and press it up and out until it is locked out overhead.

Lower the kettlebell back to your shoulder under control and repeat. Make sure to contract your lat, butt, and stomach forcefully for added stability and strength.', 'One-Arm_Kettlebell_Military_Press_To_The_Side/0.jpg', 'One-Arm_Kettlebell_Military_Press_To_The_Side'),
  ('One-Arm Kettlebell Para Press', 'schouders', false, 'intermediate', 'Clean a kettlebell to your shoulder. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulder. Rotate your wrist as you do so, so that the palm faces forward. This will be your starting position.

Hold the kettlebell with the elbow out to the side, and press it up and out until it is locked out overhead.

Lower the kettlebell back to your shoulder under control and repeat. Make sure to contract your lat, butt, and stomach forcefully for added stability and strength.', 'One-Arm_Kettlebell_Para_Press/0.jpg', 'One-Arm_Kettlebell_Para_Press'),
  ('One-Arm Kettlebell Push Press', 'schouders', false, 'intermediate', 'Hold a kettlebell by the handle. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulder. Rotate your wrist as you do so, so that the palm faces forward. This will be your starting position.

Dip your body by bending the knees, keeping your torso upright.

Immediately reverse direction, driving through the heels, in essence jumping to create momentum. As you do so, press the kettlebell overhead to lockout by extending the arms, using your body''s momentum to move the weight. Lower the weight to perform the next repetition.', 'One-Arm_Kettlebell_Push_Press/0.jpg', 'One-Arm_Kettlebell_Push_Press'),
  ('One-Arm Kettlebell Row', 'rug', false, 'intermediate', 'Place a kettlebell in front of your feet. Bend your knees slightly and then push your butt out as much as possible as you bend over to get in the starting position. Grab the kettlebell and pull it to your stomach, retracting your shoulder blade and flexing the elbow. Keep your back straight. Lower and repeat.', 'One-Arm_Kettlebell_Row/0.jpg', 'One-Arm_Kettlebell_Row'),
  ('One-Arm Kettlebell Snatch', 'schouders', false, 'expert', 'Place a kettlebell between your feet. Bend your knees and push your butt back to get in the proper starting position.

Look straight ahead and swing the kettlebell back between your legs.

Immediately reverse the direction and drive through with your hips and knees, accelerating the kettlebell upward. As the kettlebell rises to your shoulder rotate your hand and punch straight up, using momentum to receive the weight locked out overhead.', 'One-Arm_Kettlebell_Snatch/0.jpg', 'One-Arm_Kettlebell_Snatch'),
  ('One-Arm Kettlebell Split Jerk', 'schouders', false, 'intermediate', 'Hold a kettlebell by the handle. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulder. Rotate your wrist as you do so, so that the palm faces forward. This will be your starting position.
...
Keeping the weight overhead, return to a standing position and bring your feet together. Lower the weight to perform the next repetition.', 'One-Arm_Kettlebell_Split_Jerk/0.jpg', 'One-Arm_Kettlebell_Split_Jerk'),
  ('One-Arm Kettlebell Split Snatch', 'schouders', false, 'expert', 'Hold a kettlebell in one hand by the handle.
...
Return to a standing position, holding the weight overhead, and bring the feet together. Lower the weight to return to the starting position.', 'One-Arm_Kettlebell_Split_Snatch/0.jpg', 'One-Arm_Kettlebell_Split_Snatch'),
  ('One-Arm Kettlebell Swings', 'benen', false, 'intermediate', null, 'One-Arm_Kettlebell_Swings/0.jpg', 'One-Arm_Kettlebell_Swings'),
  ('One-Arm Long Bar Row', 'rug', false, 'beginner', 'Position a bar into a landmine or in a corner to keep it from moving. Load an appropriate weight onto your end.
...
After a brief pause, return to the starting position.', 'One-Arm_Long_Bar_Row/0.jpg', 'One-Arm_Long_Bar_Row'),
  ('One-Arm Open Palm Kettlebell Clean', 'benen', false, 'intermediate', 'Place one kettlebell between your feet.
...
Take the kettlebell to the floor and repeat. Make sure to work both arms.', 'One-Arm_Open_Palm_Kettlebell_Clean/0.jpg', 'One-Arm_Open_Palm_Kettlebell_Clean'),
  ('One-Arm Overhead Kettlebell Squats', 'benen', false, 'expert', 'Clean and press a kettlebell with one arm. Clean the kettlebell to your shoulder by extending through the legs and hips as you pull the kettlebell towards your shoulder. Rotate your wrist as you do so. Press the weight overhead by extending through the elbow.This will be your starting position.
...
Pause at the bottom position for a second before rising back to the top, driving through the heels of your feet.', 'One-Arm_Overhead_Kettlebell_Squats/0.jpg', 'One-Arm_Overhead_Kettlebell_Squats'),
  ('One-Arm Side Deadlift', 'benen', false, 'expert', 'Stand to the side of a barbell next to its center. Bend your knees and lower your body until you are able to reach the barbell.
...
Switch arms and repeat the movement.', 'One-Arm_Side_Deadlift/0.jpg', 'One-Arm_Side_Deadlift'),
  ('One-Arm Side Laterals', 'schouders', false, 'beginner', 'Pick a dumbbell and place it in one of your hands. Your non lifting hand should be used to grab something steady such as an incline bench press. Lean towards your lifting arm and away from the hand that is gripping the incline bench as this will allow you to keep your balance.
...
Switch arms and repeat the exercise.', 'One-Arm_Side_Laterals/0.jpg', 'One-Arm_Side_Laterals'),
  ('One-Legged Cable Kickback', 'benen', false, 'intermediate', 'Hook a leather ankle cuff to a low cable pulley and then attach the cuff to your ankle.
...
Switch legs and repeat the movement for the other side.', 'One-Legged_Cable_Kickback/0.jpg', 'One-Legged_Cable_Kickback'),
  ('One Arm Dumbbell Bench Press', 'borst', false, 'beginner', 'Lie down on a flat bench with a dumbbell in one hand on top of your thigh.
...
Switch arms and repeat the movement.', 'One_Arm_Dumbbell_Bench_Press/0.jpg', 'One_Arm_Dumbbell_Bench_Press'),
  ('One Arm Dumbbell Preacher Curl', 'armen', false, 'beginner', 'Grab a dumbbell with the right arm and place the upper arm on top of the preacher bench or the incline bench. The dumbbell should be held at shoulder length. This will be your starting position.
...
Switch arms and repeat the movement.', 'One_Arm_Dumbbell_Preacher_Curl/0.jpg', 'One_Arm_Dumbbell_Preacher_Curl'),
  ('One Arm Floor Press', 'armen', false, 'intermediate', 'Lie down on a flat surface with your back pressing against the floor or an exercise mat. Make sure your knees are bent.
...
Switch arms and repeat the movement.', 'One_Arm_Floor_Press/0.jpg', 'One_Arm_Floor_Press'),
  ('One Arm Lat Pulldown', 'rug', false, 'beginner', 'Select an appropriate weight and adjust the knee pad to help keep you down. Grasp the handle with a pronated grip. This will be your starting position.
...
For multiple repetitions, avoid completely returning the weight to keep tension on the muscles being worked.', 'One_Arm_Lat_Pulldown/0.jpg', 'One_Arm_Lat_Pulldown'),
  ('One Arm Pronated Dumbbell Triceps Extension', 'armen', false, 'beginner', 'Lie flat on a bench while holding a dumbbell at arms length. Your arm should be perpendicular to your body. The palm of your hand should be facing towards your feet as a pronated grip is required to perform this exercise.
...
Switch arms and repeat the movement.', 'One_Arm_Pronated_Dumbbell_Triceps_Extension/0.jpg', 'One_Arm_Pronated_Dumbbell_Triceps_Extension'),
  ('One Arm Supinated Dumbbell Triceps Extension', 'armen', false, 'beginner', 'Lie flat on a bench while holding a dumbbell at arms length. Your arm should be perpendicular to your body. The palm of your hand should be facing towards your face as a supinated grip is required to perform this exercise.
...
Switch arms again and repeat the movement.', 'One_Arm_Supinated_Dumbbell_Triceps_Extension/0.jpg', 'One_Arm_Supinated_Dumbbell_Triceps_Extension'),
  ('One Leg Barbell Squat', 'benen', false, 'expert', 'Start by standing about 2 to 3 feet in front of a flat bench with your back facing the bench. Have a barbell in front of you on the floor. Tip: Your feet should be shoulder width apart from each other.
...
Switch legs and repeat the movement.', 'One_Leg_Barbell_Squat/0.jpg', 'One_Leg_Barbell_Squat'),
  ('Open Palm Kettlebell Clean', 'benen', false, 'expert', 'Place one kettlebell between your feet. Clean the kettlebell by extending through the legs and hips as you raise the kettlebell towards your shoulders.
...
Release the kettlebell out in front of you and catch the handle with both hands. Lower the kettlebell to the starting position and repeat.', 'Open_Palm_Kettlebell_Clean/0.jpg', 'Open_Palm_Kettlebell_Clean'),
  ('Overhead Cable Curl', 'armen', false, 'intermediate', 'To begin, set a weight that is comfortable on each side of the pulley machine. Note: Make sure that the amount of weight selected is the same on each side.
...
Repeat for the recommended amount of repetitions prescribed in your program.', 'Overhead_Cable_Curl/0.jpg', 'Overhead_Cable_Curl'),
  ('Pallof Press', 'core', false, 'beginner', 'Connect a standard handle to a tower, and—if possible—position the cable to shoulder height. If not, a low pulley will suffice.
...
At the conclusion of the set, repeat facing the other direction.', 'Pallof_Press/0.jpg', 'Pallof_Press'),
  ('Pallof Press With Rotation', 'core', false, 'beginner', 'Connect a standard handle to a tower, and position the cable to shoulder height.
...
Then, reposition and repeat the same series of movements on the opposite side.', 'Pallof_Press_With_Rotation/0.jpg', 'Pallof_Press_With_Rotation'),
  ('Palms-Down Dumbbell Wrist Curl Over A Bench', 'armen', false, 'beginner', 'Start out by placing two dumbbells on one side of a flat bench.
...
Repeat for the recommended amount of repetitions.', 'Palms-Down_Dumbbell_Wrist_Curl_Over_A_Bench/0.jpg', 'Palms-Down_Dumbbell_Wrist_Curl_Over_A_Bench'),
  ('Palms-Down Wrist Curl Over A Bench', 'armen', false, 'beginner', 'Start out by placing a barbell on one side of a flat bench.
...
Repeat for the recommended amount of repetitions.', 'Palms-Down_Wrist_Curl_Over_A_Bench/0.jpg', 'Palms-Down_Wrist_Curl_Over_A_Bench'),
  ('Palms-Up Barbell Wrist Curl Over A Bench', 'armen', false, 'beginner', 'Start out by placing a barbell on one side of a flat bench.
...
Repeat for the recommended amount of repetitions.', 'Palms-Up_Barbell_Wrist_Curl_Over_A_Bench/0.jpg', 'Palms-Up_Barbell_Wrist_Curl_Over_A_Bench'),
  ('Palms-Up Dumbbell Wrist Curl Over A Bench', 'armen', false, 'beginner', 'Start out by placing two dumbbells on one side of a flat bench.
...
Repeat for the recommended amount of repetitions.', 'Palms-Up_Dumbbell_Wrist_Curl_Over_A_Bench/0.jpg', 'Palms-Up_Dumbbell_Wrist_Curl_Over_A_Bench'),
  ('Plank', 'core', false, 'beginner', 'Get into a prone position on the floor, supporting your weight on your toes and your forearms. Your arms are bent and directly below the shoulder.

Keep your body straight at all times, and hold this position as long as possible. To increase difficulty, an arm or leg can be raised.', 'Plank/0.jpg', 'Plank'),
  ('Plie Dumbbell Squat', 'benen', false, 'beginner', 'Hold a dumbbell at the base with both hands and stand straight up. Move your legs so that they are wider than shoulder width apart from each other with your knees slightly bent.
...
Repeat for the recommended amount of repetitions.', 'Plie_Dumbbell_Squat/0.jpg', 'Plie_Dumbbell_Squat'),
  ('Plyo Kettlebell Pushups', 'borst', false, 'expert', 'Place a kettlebell on the floor. Place yourself in a pushup position, on your toes with one hand on the ground and one hand holding the kettlebell, with your elbows extended. This will be your starting position.

Begin by lowering yourself as low as you can, keeping your back straight.

Quickly and forcefully reverse direction, pushing yourself up to the other side of the kettlebell, switching hands as you do so. Continue the movement by descending and repeating the movement back and forth.', 'Plyo_Kettlebell_Pushups/0.jpg', 'Plyo_Kettlebell_Pushups'),
  ('Power Clean', 'benen', false, 'intermediate', 'Stand with your feet slightly wider than shoulder width apart and toes pointing out slightly.
...
Start over at Phase 1 and repeat for the recommended amount of repetitions.', 'Power_Clean/0.jpg', 'Power_Clean'),
  ('Power Partials', 'schouders', false, 'beginner', 'Stand up with your torso upright and a dumbbell on each hand being held at arms length. The elbows should be close to the torso.
...
Repeat for the recommended amount of repetitions.', 'Power_Partials/0.jpg', 'Power_Partials'),
  ('Preacher Curl', 'armen', false, 'beginner', 'To perform this movement you will need a preacher bench and an E-Z bar. Grab the E-Z curl bar at the close inner handle (either have someone hand you the bar which is preferable or grab the bar from the front bar rest provided by most preacher benches). The palm of your hands should be facing forward and they should be slightly tilted inwards due to the shape of the bar.
...
Repeat for the recommended amount of repetitions.', 'Preacher_Curl/0.jpg', 'Preacher_Curl'),
  ('Preacher Hammer Dumbbell Curl', 'armen', false, 'beginner', 'Place the upper part of both arms on top of the preacher bench as you hold a dumbbell in each hand with the palms facing each other (neutral grip).
...
Squeeze the biceps hard for a second at the contracted position and repeat for the recommended amount of repetitions.', 'Preacher_Hammer_Dumbbell_Curl/0.jpg', 'Preacher_Hammer_Dumbbell_Curl'),
  ('Press Sit-Up', 'core', false, 'expert', 'To begin, lie down on a bench with a barbell resting on your chest. Position your legs so they are secure on the extension of the abdominal bench. This is the starting position.
...
Repeat for the recommended amount of repetitions.', 'Press_Sit-Up/0.jpg', 'Press_Sit-Up'),
  ('Pull Through', 'benen', false, 'beginner', 'Begin standing a few feet in front of a low pulley with a rope or handle attached. Face away from the machine, straddling the cable, with your feet set wide apart.

Begin the movement by reaching through your legs as far as possible, bending at the hips. Keep your knees slightly bent. Keeping your arms straight, extend through the hip to stand straight up. Avoid pulling upward through the shoulders; all of the motion should originate through the hips.', 'Pull_Through/0.jpg', 'Pull_Through'),
  ('Pullups', 'rug', false, 'beginner', 'Grab the pull-up bar with the palms facing forward using the prescribed grip. Note on grips: For a wide grip, your hands need to be spaced out at a distance wider than your shoulder width. For a medium grip, your hands need to be spaced out at a distance equal to your shoulder width and for a close grip at a distance smaller than your shoulder width.
...
Repeat this motion for the prescribed amount of repetitions.', 'Pullups/0.jpg', 'Pullups'),
  ('Push-Up Wide', 'borst', false, 'beginner', 'With your hands wide apart, support your body on your toes and hands in a plank position. Your elbows should be extended and your body straight. Do not allow your hips to sag. This will be your starting position.
...
After pausing at the contracted position, repeat the movement for the prescribed amount of repetitions.', 'Push-Up_Wide/0.jpg', 'Push-Up_Wide'),
  ('Push-Ups - Close Triceps Position', 'armen', false, 'intermediate', 'Lie on the floor face down and place your hands closer than shoulder width for a close hand position. Make sure that you are holding your torso up at arms'' length.
...
After a second pause at the contracted position, repeat the movement for the prescribed amount of repetitions.', 'Push-Ups_-_Close_Triceps_Position/0.jpg', 'Push-Ups_-_Close_Triceps_Position'),
  ('Push-Ups With Feet Elevated', 'borst', false, 'beginner', 'Lie on the floor face down and place your hands about 36 inches apart from each other holding your torso up at arms length.
...
After a second pause at the contracted position, repeat the movement for the prescribed amount of repetitions.', 'Push-Ups_With_Feet_Elevated/0.jpg', 'Push-Ups_With_Feet_Elevated'),
  ('Push Up to Side Plank', 'borst', false, 'beginner', 'Get into pushup position on the toes with your hands just outside of shoulder width.
...
Repeat the series, alternating each side, for 10 or more reps.', 'Push_Up_to_Side_Plank/0.jpg', 'Push_Up_to_Side_Plank'),
  ('Pushups', 'borst', false, 'beginner', 'Lie on the floor face down and place your hands about 36 inches apart while holding your torso up at arms length.

Next, lower yourself downward until your chest almost touches the floor as you inhale.

Now breathe out and press your upper body back up to the starting position while squeezing your chest.

After a brief pause at the top contracted position, you can begin to lower yourself downward again for as many repetitions as needed.', 'Pushups/0.jpg', 'Pushups'),
  ('Pushups (Close and Wide Hand Positions)', 'borst', false, 'beginner', 'Lie on the floor face down and body straight with your toes on the floor and the hands wider than shoulder width for a wide hand position and closer than shoulder width for a close hand position. Make sure you are holding your torso up at arms length.

Lower yourself until your chest almost touches the floor as you inhale.

Using your pectoral muscles, press your upper body back up to the starting position and squeeze your chest. Breathe out as you perform this step.

After a second pause at the contracted position, repeat the movement for the prescribed amount of repetitions.', 'Pushups_Close_and_Wide_Hand_Positions/0.jpg', 'Pushups_Close_and_Wide_Hand_Positions'),
  ('Reverse Barbell Curl', 'armen', false, 'beginner', 'Stand up with your torso upright while holding a barbell at shoulder width with the elbows close to the torso. The palm of your hands should be facing down (pronated grip). This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Reverse_Barbell_Curl/0.jpg', 'Reverse_Barbell_Curl'),
  ('Reverse Barbell Preacher Curls', 'armen', false, 'intermediate', 'Grab an EZ-bar using a shoulder width and palms down (pronated) grip.
...
Repeat for the recommended amount of repetitions.', 'Reverse_Barbell_Preacher_Curls/0.jpg', 'Reverse_Barbell_Preacher_Curls'),
  ('Reverse Cable Curl', 'armen', false, 'beginner', 'Stand up with your torso upright while holding a bar attachment that is attached to a low pulley using a pronated (palms down) and shoulder width grip. Make sure also that you keep the elbows close to the torso. This will be your starting position.

While holding the upper arms stationary, curl the weights while contracting the biceps as you breathe out. Only the forearms should move. Continue the movement until your biceps are fully contracted and the bar is at shoulder level. Hold the contracted position for a second as you squeeze the muscle.

Slowly begin to bring the bar back to starting position as your breathe in.

Repeat for the recommended amount of repetitions.', 'Reverse_Cable_Curl/0.jpg', 'Reverse_Cable_Curl'),
  ('Reverse Crunch', 'core', false, 'beginner', 'Lie down on the floor with your legs fully extended and arms to the side of your torso with the palms on the floor. Your arms should be stationary for the entire exercise.
...
Repeat for the recommended amount of repetitions.', 'Reverse_Crunch/0.jpg', 'Reverse_Crunch'),
  ('Reverse Flyes', 'schouders', false, 'beginner', 'To begin, lie down on an incline bench with the chest and stomach pressing against the incline. Have the dumbbells in each hand with the palms facing each other (neutral grip).
...
Repeat for the recommended amount of repetitions.', 'Reverse_Flyes/0.jpg', 'Reverse_Flyes'),
  ('Reverse Flyes With External Rotation', 'schouders', false, 'intermediate', 'To begin, lie down on an incline bench set at a 30-degree angle with the chest and stomach pressing against the incline.
...
Repeat for the recommended amount of repetitions.', 'Reverse_Flyes_With_External_Rotation/0.jpg', 'Reverse_Flyes_With_External_Rotation'),
  ('Reverse Grip Bent-Over Rows', 'rug', false, 'intermediate', 'Stand erect while holding a barbell with a supinated grip (palms facing up).
...
Repeat for the recommended amount of repetitions.', 'Reverse_Grip_Bent-Over_Rows/0.jpg', 'Reverse_Grip_Bent-Over_Rows'),
  ('Reverse Grip Triceps Pushdown', 'armen', false, 'beginner', 'Start by setting a bar attachment (straight or e-z) on a high pulley machine.
...
Repeat for the recommended amount of repetitions.', 'Reverse_Grip_Triceps_Pushdown/0.jpg', 'Reverse_Grip_Triceps_Pushdown'),
  ('Reverse Hyperextension', 'benen', false, 'intermediate', 'Place your feet between the pads after loading an appropriate weight. Lay on the top pad, allowing your hips to hang off the back, while grasping the handles to hold your position.
...
Repeat for the desired number of repetitions.', 'Reverse_Hyperextension/0.jpg', 'Reverse_Hyperextension'),
  ('Reverse Machine Flyes', 'schouders', false, 'beginner', 'Adjust the handles so that they are fully to the rear. Make an appropriate weight selection and adjust the seat height so the handles are at shoulder level. Grasp the handles with your hands facing inwards. This will be your starting position.
...
Pause at the rear of the movement, and slowly return the weight to the starting position.', 'Reverse_Machine_Flyes/0.jpg', 'Reverse_Machine_Flyes'),
  ('Reverse Triceps Bench Press', 'armen', false, 'intermediate', 'Lie back on a flat bench. Using a close, supinated grip (around shoulder width), lift the bar from the rack and hold it straight over you with your arms locked extended in front of you and perpendicular to the floor. This will be your starting position.
...
When you are done, place the bar back in the rack.', 'Reverse_Triceps_Bench_Press/0.jpg', 'Reverse_Triceps_Bench_Press'),
  ('Rocking Standing Calf Raise', 'benen', false, 'beginner', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place it on the back of your shoulders (slightly below the neck).
...
Repeat for the recommended amount of repetitions.', 'Rocking_Standing_Calf_Raise/0.jpg', 'Rocking_Standing_Calf_Raise'),
  ('Romanian Deadlift', 'benen', false, 'intermediate', 'Put a barbell in front of you on the ground and grab it using a pronated (palms facing down) grip that a little wider than shoulder width. Tip: Depending on the weight used, you may need wrist wraps to perform the exercise and also a raised platform in order to allow for better range of motion.
...
Repeat for the recommended amount of repetitions.', 'Romanian_Deadlift/0.jpg', 'Romanian_Deadlift'),
  ('Rope Crunch', 'core', false, 'beginner', 'Kneel 1-2 feet in front of a cable system with a rope attached.
...
These can be done with twists or to the side to hit the obliques.', 'Rope_Crunch/0.jpg', 'Rope_Crunch'),
  ('Rope Straight-Arm Pulldown', 'rug', false, 'beginner', 'Attach a rope to a high pulley and make your weight selection. Stand a couple feet back from the pulley with your feet staggered and take the rope with both hands. Lean forward from the hip, keeping your back straight, with your arms extended up in front of you. This will be your starting position.
...
Return to the starting position without allowing the weight to fully rest on the stack.', 'Rope_Straight-Arm_Pulldown/0.jpg', 'Rope_Straight-Arm_Pulldown'),
  ('Russian Twist', 'core', false, 'intermediate', 'Lie down on the floor placing your feet either under something that will not move or by having a partner hold them. Your legs should be bent at the knees.
...
Repeat for the recommended amount of repetitions.', 'Russian_Twist/0.jpg', 'Russian_Twist'),
  ('Seated Barbell Military Press', 'schouders', false, 'intermediate', 'Sit on a Military Press Bench with a bar behind your head and either have a spotter give you the bar (better on the rotator cuff this way) or pick it up yourself carefully with a pronated grip (palms facing forward). Tip: Your grip should be wider than shoulder width and it should create a 90-degree angle between the forearm and the upper arm as the barbell goes down.
...
Repeat for the recommended amount of repetitions.', 'Seated_Barbell_Military_Press/0.jpg', 'Seated_Barbell_Military_Press'),
  ('Seated Barbell Twist', 'core', false, 'beginner', 'Start out by sitting at the end of a flat bench with a barbell placed on top of your thighs. Your feet should be shoulder width apart from each other.
...
Repeat for the recommended amount of repetitions.', 'Seated_Barbell_Twist/0.jpg', 'Seated_Barbell_Twist'),
  ('Seated Bent-Over One-Arm Dumbbell Triceps Extension', 'armen', false, 'beginner', 'Sit down at the end of a flat bench with a dumbbell in one arm using a neutral grip (palms of the hand facing you).
...
Switch arms and repeat the exercise.', 'Seated_Bent-Over_One-Arm_Dumbbell_Triceps_Extension/0.jpg', 'Seated_Bent-Over_One-Arm_Dumbbell_Triceps_Extension'),
  ('Seated Bent-Over Rear Delt Raise', 'schouders', false, 'intermediate', 'Place a couple of dumbbells looking forward in front of a flat bench.
...
Repeat for the recommended amount of repetitions.', 'Seated_Bent-Over_Rear_Delt_Raise/0.jpg', 'Seated_Bent-Over_Rear_Delt_Raise'),
  ('Seated Bent-Over Two-Arm Dumbbell Triceps Extension', 'armen', false, 'intermediate', 'Sit down at the end of a flat bench with a dumbbell in both arms using a neutral grip (palms of the hand facing you).
...
Repeat the movement for the prescribed amount of repetitions.', 'Seated_Bent-Over_Two-Arm_Dumbbell_Triceps_Extension/0.jpg', 'Seated_Bent-Over_Two-Arm_Dumbbell_Triceps_Extension'),
  ('Seated Cable Rows', 'rug', false, 'beginner', 'For this exercise you will need access to a low pulley row machine with a V-bar. Note: The V-bar will enable you to have a neutral grip where the palms of your hands face each other. To get into the starting position, first sit down on the machine and place your feet on the front platform or crossbar provided making sure that your knees are slightly bent and not locked.
...
Repeat for the recommended amount of repetitions.', 'Seated_Cable_Rows/0.jpg', 'Seated_Cable_Rows'),
  ('Seated Cable Shoulder Press', 'schouders', false, 'beginner', 'Adjust the weight to an appropriate amount and be seated, grasping the handles. Your upper arms should be about 90 degrees to the body, with your head and chest up. The elbows should also be bent to about 90 degrees. This will be your starting position.
...
You can also execute this movement with your back off the pad and alternate hands.', 'Seated_Cable_Shoulder_Press/0.jpg', 'Seated_Cable_Shoulder_Press'),
  ('Seated Calf Raise', 'benen', false, 'beginner', 'Sit on the machine and place your toes on the lower portion of the platform provided with the heels extending off. Choose the toe positioning of your choice (forward, in, or out) as per the beginning of this chapter.
...
Repeat for the recommended amount of repetitions.', 'Seated_Calf_Raise/0.jpg', 'Seated_Calf_Raise'),
  ('Seated Close-Grip Concentration Barbell Curl', 'armen', false, 'intermediate', 'Sit down on a flat bench with a barbell or E-Z Bar in front of you in between your legs. Your legs should be spread with the knees bent and the feet on the floor.
...
Repeat for the recommended amount of repetitions.', 'Seated_Close-Grip_Concentration_Barbell_Curl/0.jpg', 'Seated_Close-Grip_Concentration_Barbell_Curl'),
  ('Seated Dumbbell Curl', 'armen', false, 'beginner', 'Sit on a flat bench with a dumbbell on each hand being held at arms length. The elbows should be close to the torso.
...
Repeat for the recommended amount of repetitions.', 'Seated_Dumbbell_Curl/0.jpg', 'Seated_Dumbbell_Curl'),
  ('Seated Dumbbell Inner Biceps Curl', 'armen', false, 'beginner', 'Sit on the end of a flat bench with a dumbbell in each hand being held at arms length. The elbows should be close to the torso.
...
Repeat for the recommended amount of repetitions.', 'Seated_Dumbbell_Inner_Biceps_Curl/0.jpg', 'Seated_Dumbbell_Inner_Biceps_Curl'),
  ('Seated Dumbbell Palms-Down Wrist Curl', 'armen', false, 'beginner', 'Start out by placing two dumbbells on the floor in front of a flat bench.
...
When finished, simply lower the dumbbells to the floor.', 'Seated_Dumbbell_Palms-Down_Wrist_Curl/0.jpg', 'Seated_Dumbbell_Palms-Down_Wrist_Curl'),
  ('Seated Dumbbell Palms-Up Wrist Curl', 'armen', false, 'beginner', 'Start out by placing two dumbbells on the floor in front of a flat bench.
...
When finished, simply lower the dumbbells to the floor.', 'Seated_Dumbbell_Palms-Up_Wrist_Curl/0.jpg', 'Seated_Dumbbell_Palms-Up_Wrist_Curl'),
  ('Seated Dumbbell Press', 'schouders', false, 'beginner', 'Grab a couple of dumbbells and sit on a military press bench or a utility bench that has a back support on it as you place the dumbbells upright on top of your thighs.
...
Repeat for the recommended amount of repetitions.', 'Seated_Dumbbell_Press/0.jpg', 'Seated_Dumbbell_Press'),
  ('Seated Flat Bench Leg Pull-In', 'core', false, 'beginner', 'Sit on a bench with the legs stretched out in front of you slightly below parallel and your arms holding on to the sides of the bench. Your torso should be leaning backwards around a 45-degree angle from the bench. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Seated_Flat_Bench_Leg_Pull-In/0.jpg', 'Seated_Flat_Bench_Leg_Pull-In'),
  ('Seated Leg Curl', 'benen', false, 'beginner', 'Adjust the machine lever to fit your height and sit on the machine with your back against the back support pad.
...
Repeat for the recommended amount of repetitions.', 'Seated_Leg_Curl/0.jpg', 'Seated_Leg_Curl'),
  ('Seated Leg Tucks', 'core', false, 'beginner', 'Sit on a bench with the legs stretched out in front of you slightly below parallel and your arms holding on to the sides of the bench. Your torso should be leaning backwards around a 45-degree angle from the bench. This will be your starting position.

Bring the knees in toward you as you move your torso closer to them at the same time. Breathe out as you perform this movement.

After a second pause, go back to the starting position as you inhale.

Repeat for the recommended amount of repetitions.', 'Seated_Leg_Tucks/0.jpg', 'Seated_Leg_Tucks'),
  ('Seated One-Arm Dumbbell Palms-Down Wrist Curl', 'armen', false, 'intermediate', 'Sit on a flat bench with a dumbbell in your right hand.
...
Perform for the recommended amount of repetitions, switch arms and repeat the movement.', 'Seated_One-Arm_Dumbbell_Palms-Down_Wrist_Curl/0.jpg', 'Seated_One-Arm_Dumbbell_Palms-Down_Wrist_Curl'),
  ('Seated One-Arm Dumbbell Palms-Up Wrist Curl', 'armen', false, 'beginner', 'Sit on a flat bench with a dumbbell in your right hand.
...
Perform for the recommended amount of repetitions, switch arms and repeat the movement.', 'Seated_One-Arm_Dumbbell_Palms-Up_Wrist_Curl/0.jpg', 'Seated_One-Arm_Dumbbell_Palms-Up_Wrist_Curl'),
  ('Seated One-arm Cable Pulley Rows', 'rug', false, 'intermediate', 'To get into the starting position, first sit down on the machine and place your feet on the front platform or crossbar provided making sure that your knees are slightly bent and not locked.
...
Repeat for the recommended amount of repetitions and then perform the same movement with the right hand.', 'Seated_One-arm_Cable_Pulley_Rows/0.jpg', 'Seated_One-arm_Cable_Pulley_Rows'),
  ('Seated Palm-Up Barbell Wrist Curl', 'armen', false, 'beginner', 'Hold a barbell with both hands and your palms facing up; hands spaced about shoulder width.
...
Now curl bar up as high as possible while flexing the forearms and exhaling. Hold the contraction at the top for a second and Tip: Only the wrist should move.', 'Seated_Palm-Up_Barbell_Wrist_Curl/0.jpg', 'Seated_Palm-Up_Barbell_Wrist_Curl'),
  ('Seated Palms-Down Barbell Wrist Curl', 'armen', false, 'beginner', 'Hold a barbell with both hands and your palms facing down; hands spaced about shoulder width.
...
Now curl bar up as high as possible while flexing the forearms and exhaling. Hold the contraction at the top for a second and Tip: Only the wrist should move.', 'Seated_Palms-Down_Barbell_Wrist_Curl/0.jpg', 'Seated_Palms-Down_Barbell_Wrist_Curl'),
  ('Seated Side Lateral Raise', 'schouders', false, 'beginner', 'Pick a couple of dumbbells and sit at the end of a flat bench with your feet firmly on the floor. Hold the dumbbells with your palms facing in and your arms straight down at your sides at arms'' length. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Seated_Side_Lateral_Raise/0.jpg', 'Seated_Side_Lateral_Raise'),
  ('Seated Triceps Press', 'armen', false, 'beginner', 'Sit down on a bench with back support and grasp a dumbbell with both hands and hold it overhead at arm''s length. Tip: a better way is to have somebody hand it to you especially if it is very heavy. The resistance should be resting in the palms of your hands with your thumbs around it. The palm of the hand should be facing inward. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Seated_Triceps_Press/0.jpg', 'Seated_Triceps_Press'),
  ('Seated Two-Arm Palms-Up Low-Pulley Wrist Curl', 'armen', false, 'beginner', 'Put a bench in front of a low pulley machine that has a barbell or EZ Curl attachment on it.
...
Repeat for the recommended amount of repetitions.', 'Seated_Two-Arm_Palms-Up_Low-Pulley_Wrist_Curl/0.jpg', 'Seated_Two-Arm_Palms-Up_Low-Pulley_Wrist_Curl'),
  ('See-Saw Press (Alternating Side Press)', 'schouders', false, 'intermediate', 'Grab a dumbbell with each hand and stand up erect.
...
Repeat for the recommended amount of repetitions.', 'See-Saw_Press_Alternating_Side_Press/0.jpg', 'See-Saw_Press_Alternating_Side_Press'),
  ('Shotgun Row', 'rug', false, 'beginner', 'Attach a single handle to a low cable.
...
After a brief pause, return to the starting position.', 'Shotgun_Row/0.jpg', 'Shotgun_Row'),
  ('Side Bridge', 'core', false, 'beginner', null, 'Side_Bridge/0.jpg', 'Side_Bridge'),
  ('Side Jackknife', 'core', false, 'beginner', null, 'Side_Jackknife/0.jpg', 'Side_Jackknife'),
  ('Side Lateral Raise', 'schouders', false, 'beginner', 'Pick a couple of dumbbells and stand with a straight torso and the dumbbells by your side at arms length with the palms of the hand facing you. This will be your starting position.

While maintaining the torso in a stationary position (no swinging), lift the dumbbells to your side with a slight bend on the elbow and the hands slightly tilted forward as if pouring water in a glass. Continue to go up until you arms are parallel to the floor. Exhale as you execute this movement and pause for a second at the top.

Lower the dumbbells back down slowly to the starting position as you inhale.

Repeat for the recommended amount of repetitions.', 'Side_Lateral_Raise/0.jpg', 'Side_Lateral_Raise'),
  ('Side Laterals to Front Raise', 'schouders', false, 'beginner', 'In a standing position, hold a pair of dumbbells at your side. This will be your starting position.
...
Lower the weights to the starting position.', 'Side_Laterals_to_Front_Raise/0.jpg', 'Side_Laterals_to_Front_Raise'),
  ('Single-Arm Cable Crossover', 'borst', false, 'beginner', 'Begin by moving the pulleys to the high position, select the resistance to be used, and take a handle in each hand.
...
Hold for a second at the starting position and repeat the movement on the opposite side. Continue alternating back and forth for the prescribed number of repetitions.', 'Single-Arm_Cable_Crossover/0.jpg', 'Single-Arm_Cable_Crossover'),
  ('Single-Arm Linear Jammer', 'schouders', false, 'intermediate', 'Position a bar into a landmine or securely anchor it in a corner. Load the bar to an appropriate weight.
...
Return to the starting position.', 'Single-Arm_Linear_Jammer/0.jpg', 'Single-Arm_Linear_Jammer'),
  ('Single-Arm Push-Up', 'borst', false, 'intermediate', 'Begin laying prone on the ground. Move yourself into a position supporting your weight on your toes and one arm. Your working arm should be placed directly under the shoulder, fully extended. Your legs should be extended, and for this movement you may need a wider base, placing your feet further apart than in a normal push-up.
...
Repeat for the desired number of repetitions.', 'Single-Leg_Leg_Extension/0.jpg', 'Single-Leg_Leg_Extension'),
  ('Single Dumbbell Raise', 'schouders', false, 'beginner', 'With a wide stance, hold a dumbell with both hands, grasping the head of the dumbbell instead of the handle. Your arms should be extended and hanging at the waist. This will be your starting position.
...
Return to the starting position and repeat for the recommended amount of repetitions.', 'Single_Dumbbell_Raise/0.jpg', 'Single_Dumbbell_Raise'),
  ('Single Leg Glute Bridge', 'benen', false, 'beginner', 'Lay on the floor with your feet flat and knees bent.
...
Extend as far as possible, pause and then return to the starting position.', 'Single_Leg_Glute_Bridge/0.jpg', 'Single_Leg_Glute_Bridge'),
  ('Sit-Up', 'core', false, 'beginner', 'Lie down on the floor placing your feet either under something that will not move or by having a partner hold them. Your legs should be bent at the knees.
...
When you are done, place the bar back in the rack.', 'Smith_Incline_Shoulder_Raise/0.jpg', 'Smith_Incline_Shoulder_Raise'),
  ('Smith Machine Behind the Back Shrug', 'rug', false, 'beginner', 'With the bar at thigh level, load an appropriate weight.
...
Repeat for the desired number of repetitions before engaging the hooks to rack the weight.', 'Smith_Machine_Behind_the_Back_Shrug/0.jpg', 'Smith_Machine_Behind_the_Back_Shrug'),
  ('Smith Machine Bench Press', 'borst', false, 'beginner', 'Place a flat bench underneath the smith machine. Now place the barbell at a height that you can reach when lying down and your arms are almost fully extended. Once the weight you need is selected, lie down on the flat bench. Using a pronated grip that is wider than shoulder width, unlock the bar from the rack and hold it straight over you with your arms locked. This will be your starting position.
...
When you are done, lock the bar back in the rack.', 'Smith_Machine_Bench_Press/0.jpg', 'Smith_Machine_Bench_Press'),
  ('Smith Machine Bent Over Row', 'rug', false, 'beginner', 'Set the barbell attached to the smith machine to a height that is about 2 inches below your knees.
...
Repeat for the recommended amount of repetitions.', 'Smith_Machine_Bent_Over_Row/0.jpg', 'Smith_Machine_Bent_Over_Row'),
  ('Smith Machine Calf Raise', 'benen', false, 'beginner', 'Place a block or weight plate below the bar on the Smith machine. Set the bar to a position that best matches your height. Once the correct height is chosen and the bar is loaded, step onto the plates with the balls of your feet and place the bar on the back of your shoulders.
...
Repeat for the recommended amount of repetitions.', 'Smith_Machine_Calf_Raise/0.jpg', 'Smith_Machine_Calf_Raise'),
  ('Smith Machine Close-Grip Bench Press', 'armen', false, 'beginner', 'Place a flat bench underneath the smith machine. Place the barbell at a height that you can reach when lying down and your arms are almost fully extended. Once the weight you need is selected, lie down on the flat bench. Using a close and pronated grip (palms facing forward) that is around shoulder width, unlock the bar from the rack and hold it straight over you with your arms locked. This will be your starting position.
...
When you are done, lock the bar back in the rack.', 'Smith_Machine_Close-Grip_Bench_Press/0.jpg', 'Smith_Machine_Close-Grip_Bench_Press'),
  ('Smith Machine Decline Press', 'borst', false, 'beginner', 'Position a decline bench in the rack so that the bar will be above your chest. Load an appropriate weight and take your place on the bench.
...
After completing the desired number of repetitions, rotate the bar to rack the weight.', 'Smith_Machine_Decline_Press/0.jpg', 'Smith_Machine_Decline_Press'),
  ('Smith Machine Hang Power Clean', 'benen', false, 'intermediate', 'Position the bar at knee height and load it to an appropriate weight.
...
Extend through the hips and knees to come to a standing position with the bar racked on your shoulders to complete the movement.', 'Smith_Machine_Hang_Power_Clean/0.jpg', 'Smith_Machine_Hang_Power_Clean'),
  ('Smith Machine Hip Raise', 'core', false, 'beginner', 'Position a bench in the rack and load the bar to an appropriate weight. Lie down on the bench, placing the bottom of your feet against the bar. Unlock the bar and extend your legs. You may need to use your hands to assist you. For added stability grasp the sides of the Smith Machine. This will be your starting position.
...
When you are done, place the bar back in the rack.', 'Smith_Machine_Incline_Bench_Press/0.jpg', 'Smith_Machine_Incline_Bench_Press'),
  ('Smith Machine Leg Press', 'benen', false, 'intermediate', 'Position a Smith machine bar a couple feet off of the ground. Ensure that it is resting on the safeties. After loading the bar to an appropriate weight, lie underneath the bar. Place the middle of your feet on the bar, tucking your knees to your chest. This will be your starting position.
...
At the top of the motion, pause briefly before returning to the starting position.', 'Smith_Machine_Leg_Press/0.jpg', 'Smith_Machine_Leg_Press'),
  ('Smith Machine One-Arm Upright Row', 'schouders', false, 'beginner', 'With the bar at thigh level, load an appropriate weight.
...
Repeat for the desired number of repetitions before engaging the hooks to rack the weight.', 'Smith_Machine_One-Arm_Upright_Row/0.jpg', 'Smith_Machine_One-Arm_Upright_Row'),
  ('Smith Machine Overhead Shoulder Press', 'schouders', false, 'beginner', 'To begin, place a flat bench (or preferably one with back support) underneath a smith machine. Position the barbell at a height so that when seated on the flat bench, the arms must be almost fully extended to reach the barbell.
...
Repeat for the recommended amount of repetitions.', 'Smith_Machine_Overhead_Shoulder_Press/0.jpg', 'Smith_Machine_Overhead_Shoulder_Press'),
  ('Smith Machine Pistol Squat', 'benen', false, 'intermediate', 'To begin, first set the bar to a position that best matches your height. Step under it and position the bar across the back of your shoulders.
...
Pause briefly at the bottom and then return to the starting position by driving through the heel of your foot, extending the knee and hip.', 'Smith_Machine_Pistol_Squat/0.jpg', 'Smith_Machine_Pistol_Squat'),
  ('Smith Machine Reverse Calf Raises', 'benen', false, 'beginner', 'Adjust the barbell on the smith machine to fit your height and align a raised platform right under the bar.
...
Repeat for the recommended amount of repetitions.', 'Smith_Machine_Reverse_Calf_Raises/0.jpg', 'Smith_Machine_Reverse_Calf_Raises'),
  ('Smith Machine Squat', 'benen', false, 'beginner', 'To begin, first set the bar on the height that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Repeat for the recommended amount of repetitions.', 'Smith_Machine_Squat/0.jpg', 'Smith_Machine_Squat'),
  ('Smith Machine Stiff-Legged Deadlift', 'benen', false, 'beginner', 'To begin, set the bar on the smith machine to a height that is around the middle of your thighs. Once the correct height is chosen and the bar is loaded, grasp the bar using a pronated (palms forward) grip that is shoulder width apart. You may need some wrist wraps if using a significant amount of weight.
...
Repeat for the recommended amount of repetitions.', 'Smith_Machine_Stiff-Legged_Deadlift/0.jpg', 'Smith_Machine_Stiff-Legged_Deadlift'),
  ('Smith Machine Upright Row', 'rug', false, 'beginner', 'To begin, set the bar on the smith machine to a height that is around the middle of your thighs. Once the correct height is chosen and the bar is loaded, grasp the bar using a pronated (palms forward) grip that is shoulder width apart. You may need some wrist wraps if using a significant amount of weight.
...
Repeat for the recommended amount of repetitions.', 'Smith_Machine_Upright_Row/0.jpg', 'Smith_Machine_Upright_Row'),
  ('Smith Single-Leg Split Squat', 'benen', false, 'beginner', 'To begin, place a flat bench 2-3 feet behind the smith machine. Then, set the bar on the height that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Switch legs and repeat the movement.', 'Smith_Single-Leg_Split_Squat/0.jpg', 'Smith_Single-Leg_Split_Squat'),
  ('Snatch Pull', 'benen', false, 'intermediate', 'With a barbell on the floor close to the shins, take a wide snatch grip. Lower your hips with the weight focused on the heels, back straight, head facing forward, chest up, with your shoulders just in front of the bar. This will be your starting position.
...
There should be no need to actively pull through the arms to accelerate the weight; at the end of the second pull, the body should be fully extended, leaning slightly back. Full extension should be violent and abrupt, and ensure that you do not prolong the extension for longer than necessary.', 'Snatch_Pull/0.jpg', 'Snatch_Pull'),
  ('Speed Squats', 'benen', false, 'expert', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Repeat for the recommended amount of repetitions.', 'Speed_Squats/0.jpg', 'Speed_Squats'),
  ('Spell Caster', 'core', false, 'beginner', 'Hold a dumbbell in each hand with a pronated grip. Your feet should be wide with your hips and knees extended. This will be your starting position.
...
Continue alternating, rotating from one side to the other until the set is complete.', 'Spell_Caster/0.jpg', 'Spell_Caster'),
  ('Spider Crawl', 'core', false, 'beginner', 'Begin in a prone position on the floor. Support your weight on your hands and toes, with your feet together and your body straight. Your arms should be bent to 90 degrees. This will be your starting position.
...
Return this leg to the starting position and repeat on the opposite side.', 'Spider_Crawl/0.jpg', 'Spider_Crawl'),
  ('Spider Curl', 'armen', false, 'beginner', 'Start out by setting the bar on the part of the preacher bench that you would normally sit on. Make sure to align the barbell properly so that it is balanced and will not fall off.
...
Repeat for the recommended amount of repetitions.', 'Spider_Curl/0.jpg', 'Spider_Curl'),
  ('Split Squat with Dumbbells', 'benen', false, 'beginner', 'Position yourself into a staggered stance with the rear foot elevated and front foot forward.
...
At the bottom of the movement, drive through the heel to extend the knee and hip to return to the starting position.', 'Split_Squat_with_Dumbbells/0.jpg', 'Split_Squat_with_Dumbbells'),
  ('Squat Jerk', 'benen', false, 'expert', 'Standing with the weight racked on the front of the shoulders, begin with the dip. With your feet directly under your hips, flex the knees without moving the hips backward. Go down only slightly, and reverse direction as powerfully as possible. Drive through the heels create as much speed and force as possible, and be sure to move your head out of the way as the bar leaves the shoulders.
...
Keeping the bar aligned over the front of the heels, your head and chest up, drive throught heels of the feet to move to a standing position. Carefully return the weight to floor.', 'Squat_Jerk/0.jpg', 'Squat_Jerk'),
  ('Squat with Plate Movers', 'benen', false, 'intermediate', 'To begin, first set the bar on a rack to just below shoulder level. Position a weight plate on the ground a couple feet back from the rack. Once the bar is loaded, step under it and place the back of your shoulders across it.
...
Place your inside foot on the weight plate, adopting a wide stance for the next repetition.', 'Squat_with_Plate_Movers/0.jpg', 'Squat_with_Plate_Movers'),
  ('Standing Alternating Dumbbell Press', 'schouders', false, 'beginner', 'Stand with a dumbbell in each hand. Raise the dumbbells to your shoulders with your palms facing forward and your elbows pointed out. This will be your starting position.
...
Repeat for the opposite side, continuing to alternate between arms.', 'Standing_Alternating_Dumbbell_Press/0.jpg', 'Standing_Alternating_Dumbbell_Press'),
  ('Standing Barbell Calf Raise', 'benen', false, 'beginner', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the bar on the back of your shoulders (slightly below the neck).
...
Repeat for the recommended amount of repetitions.', 'Standing_Barbell_Calf_Raise/0.jpg', 'Standing_Barbell_Calf_Raise'),
  ('Standing Barbell Press Behind Neck', 'schouders', false, 'intermediate', 'This exercise is best performed inside a squat rack for easier pick up of the bar. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Repeat for the recommended amount of repetitions.', 'Standing_Barbell_Press_Behind_Neck/0.jpg', 'Standing_Barbell_Press_Behind_Neck'),
  ('Standing Bent-Over One-Arm Dumbbell Triceps Extension', 'armen', false, 'beginner', 'With a dumbbell in one hand and the palm facing your torso, bend your knees slightly and bring your torso forward, by bending at the waist, while keeping the back straight until it is almost parallel to the floor. Make sure that you keep the head up.
...
Switch arms and repeat the exercise.', 'Standing_Bent-Over_One-Arm_Dumbbell_Triceps_Extension/0.jpg', 'Standing_Bent-Over_One-Arm_Dumbbell_Triceps_Extension'),
  ('Standing Bent-Over Two-Arm Dumbbell Triceps Extension', 'armen', false, 'beginner', 'With a dumbbell in each hand and the palms facing your torso, bend your knees slightly and bring your torso forward, by bending at the waist, while keeping the back straight until it is almost parallel to the floor. Make sure that you keep the head up. The upper arms should be close to the torso and parallel to the floor while the forearms are pointing towards the floor as the hands hold the weights. Tip: There should be a 90-degree angle between the forearms and the upper arm. This is your starting position.
...
Repeat the movement for the prescribed amount of repetitions.', 'Standing_Bent-Over_Two-Arm_Dumbbell_Triceps_Extension/0.jpg', 'Standing_Bent-Over_Two-Arm_Dumbbell_Triceps_Extension'),
  ('Standing Biceps Cable Curl', 'armen', false, 'beginner', 'Stand up with your torso upright while holding a cable curl bar that is attached to a low pulley. Grab the cable bar at shoulder width and keep the elbows close to the torso. The palm of your hands should be facing up (supinated grip). This will be your starting position.

While holding the upper arms stationary, curl the weights while contracting the biceps as you breathe out. Only the forearms should move. Continue the movement until your biceps are fully contracted and the bar is at shoulder level. Hold the contracted position for a second as you squeeze the muscle.

Slowly begin to bring the curl bar back to starting position as your breathe in.

Repeat for the recommended amount of repetitions.', 'Standing_Biceps_Cable_Curl/0.jpg', 'Standing_Biceps_Cable_Curl'),
  ('Standing Bradford Press', 'schouders', false, 'beginner', 'Place a loaded bar at shoulder level in a rack. With a pronated grip at shoulder width, begin with the bar racked across the front of your shoulders. This is your starting position.
...
Alternate in this manner until you complete the recommended amount of repetitions.', 'Standing_Bradford_Press/0.jpg', 'Standing_Bradford_Press'),
  ('Standing Cable Chest Press', 'borst', false, 'beginner', 'Position dual pulleys to chest height and select an appropriate weight. Stand a foot or two in front of the cables, holding one in each hand. You can stagger your stance for better stability.
...
Pause at the top of the motion, and return to the starting position.', 'Standing_Cable_Chest_Press/0.jpg', 'Standing_Cable_Chest_Press'),
  ('Standing Cable Lift', 'core', false, 'beginner', 'Connect a standard handle on a tower, and move the cable to the lowest pulley position.
...
Then, reposition and repeat the same series of movements on the opposite side.', 'Standing_Cable_Lift/0.jpg', 'Standing_Cable_Lift'),
  ('Standing Cable Wood Chop', 'core', false, 'beginner', 'Connect a standard handle to a tower, and move the cable to the highest pulley position.
...
Then, reposition and repeat the same series of movements on the opposite side.', 'Standing_Cable_Wood_Chop/0.jpg', 'Standing_Cable_Wood_Chop'),
  ('Standing Calf Raises', 'benen', false, 'beginner', 'Adjust the padded lever of the calf raise machine to fit your height.
...
Repeat for the recommended amount of repetitions.', 'Standing_Calf_Raises/0.jpg', 'Standing_Calf_Raises'),
  ('Standing Concentration Curl', 'armen', false, 'beginner', 'Taking a dumbbell in your working hand, lean forward. Allow your working arm to hang perpendicular to the ground with the elbow pointing out. This will be your starting position.
...
Repeat the movement for the prescribed amount of repetitions.', 'Standing_Concentration_Curl/0.jpg', 'Standing_Concentration_Curl'),
  ('Standing Dumbbell Calf Raise', 'benen', false, 'intermediate', 'Stand with your torso upright holding two dumbbells in your hands by your sides. Place the ball of the foot on a sturdy and stable wooden board (that is around 2-3 inches tall) while your heels extend off and touch the floor. This will be your starting position.
...
Repeat for the recommended amount of times.', 'Standing_Dumbbell_Calf_Raise/0.jpg', 'Standing_Dumbbell_Calf_Raise'),
  ('Standing Dumbbell Press', 'schouders', false, 'beginner', 'Standing with your feet shoulder width apart, take a dumbbell in each hand. Raise the dumbbells to head height, the elbows out and about 90 degrees. This will be your starting position.
...
Pause, and slowly return the weight to the starting position.', 'Standing_Dumbbell_Press/0.jpg', 'Standing_Dumbbell_Press'),
  ('Standing Dumbbell Reverse Curl', 'armen', false, 'intermediate', 'To begin, stand straight with a dumbbell in each hand using a pronated grip (palms facing down). Your arms should be fully extended while your feet are shoulder width apart from each other. This is the starting position.
...
Repeat for the recommended amount of repetitions.', 'Standing_Dumbbell_Reverse_Curl/0.jpg', 'Standing_Dumbbell_Reverse_Curl'),
  ('Standing Dumbbell Straight-Arm Front Delt Raise Above Head', 'schouders', false, 'intermediate', 'Hold the dumbbells in front of your thighs, palms facing your thighs.
...
Repeat for the recommended amount of repetitions.', 'Standing_Dumbbell_Straight-Arm_Front_Delt_Raise_Above_Head/0.jpg', 'Standing_Dumbbell_Straight-Arm_Front_Delt_Raise_Above_Head'),
  ('Standing Dumbbell Triceps Extension', 'armen', false, 'beginner', 'To begin, stand up with a dumbbell held by both hands. Your feet should be about shoulder width apart from each other. Slowly use both hands to grab the dumbbell and lift it over your head until both arms are fully extended.
...
Repeat for the recommended amount of repetitions.', 'Standing_Dumbbell_Triceps_Extension/0.jpg', 'Standing_Dumbbell_Triceps_Extension'),
  ('Standing Dumbbell Upright Row', 'rug', false, 'beginner', 'Grasp a dumbbell in each hand with a pronated (palms forward) grip that is slightly less than shoulder width. The dumbbells should be resting on top of your thighs. Your arms should be extended with a slight bend at the elbows and your back should be straight. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Standing_Dumbbell_Upright_Row/0.jpg', 'Standing_Dumbbell_Upright_Row'),
  ('Standing Front Barbell Raise Over Head', 'schouders', false, 'intermediate', 'To begin, stand straight with a barbell in your hands. You should grip the bar with palms facing down and a closer than shoulder width grip apart from each other.
...
Repeat for the recommended amount of repetitions.', 'Standing_Front_Barbell_Raise_Over_Head/0.jpg', 'Standing_Front_Barbell_Raise_Over_Head'),
  ('Standing Inner-Biceps Curl', 'armen', false, 'intermediate', 'Stand up with a dumbbell in each hand being held at arms length. The elbows should be close to the torso. Your legs should be at about shoulder''s width apart from each other.
...
Perform the same exercise now for the left leg.', 'Standing_Leg_Curl/0.jpg', 'Standing_Leg_Curl'),
  ('Standing Low-Pulley Deltoid Raise', 'schouders', false, 'beginner', 'Start by standing to the right side of a low pulley row. Use your left hand to come across the body and grab a single handle attached to the low pulley with a pronated grip (palms facing down). Rest your arm in front of you. Your right hand should grab the machine for better support and balance.
...
Switch arms and repeat the exercise.', 'Standing_Low-Pulley_One-Arm_Triceps_Extension/0.jpg', 'Standing_Low-Pulley_One-Arm_Triceps_Extension'),
  ('Standing Military Press', 'schouders', false, 'beginner', 'Start by placing a barbell that is about chest high on a squat rack. Once you have selected the weights, grab the barbell using a pronated (palms facing forward) grip. Make sure to grip the bar wider than shoulder width apart from each other.
...
Repeat for the recommended amount of repetitions.', 'Standing_Military_Press/0.jpg', 'Standing_Military_Press'),
  ('Standing One-Arm Cable Curl', 'armen', false, 'intermediate', 'Start out by grabbing single handle next to the low pulley machine. Make sure you are far enough from the machine so that your arm is supporting the weight.
...
Switch arms while performing this exercise.', 'Standing_One-Arm_Cable_Curl/0.jpg', 'Standing_One-Arm_Cable_Curl'),
  ('Standing One-Arm Dumbbell Curl Over Incline Bench', 'armen', false, 'beginner', 'Stand on the back side of an incline bench as if you were going to be a spotter for someone. Have a dumbbell in one hand and rest it across the incline bench with a supinated (palms up) grip.
...
Switch arms while performing this exercise.', 'Standing_One-Arm_Dumbbell_Curl_Over_Incline_Bench/0.jpg', 'Standing_One-Arm_Dumbbell_Curl_Over_Incline_Bench'),
  ('Standing One-Arm Dumbbell Triceps Extension', 'armen', false, 'beginner', 'To begin, stand up with a dumbbell held in one hand. Your feet should be about shoulder width apart from each other. Now fully extend the arm with the dumbbell over your head. Tip: The small finger of your hand should be facing the ceiling and the palm of your hand should be facing forward. The dumbbell should be above your head.
...
Switch arms and repeat the exercise.', 'Standing_One-Arm_Dumbbell_Triceps_Extension/0.jpg', 'Standing_One-Arm_Dumbbell_Triceps_Extension'),
  ('Standing Overhead Barbell Triceps Extension', 'armen', false, 'beginner', 'To begin, stand up holding a barbell or e-z bar using a pronated grip (palms facing forward) with your hands closer than shoulder width apart from each other. Your feet should be about shoulder width apart.
...
Repeat for the recommended amount of repetitions.', 'Standing_Overhead_Barbell_Triceps_Extension/0.jpg', 'Standing_Overhead_Barbell_Triceps_Extension'),
  ('Standing Palm-In One-Arm Dumbbell Press', 'schouders', false, 'beginner', 'Start by having a dumbbell in one hand with your arm fully extended to the side using a neutral grip. Use your other arm to hold on to an incline bench to keep your balance.
...
Switch arms and repeat the exercise.', 'Standing_Palm-In_One-Arm_Dumbbell_Press/0.jpg', 'Standing_Palm-In_One-Arm_Dumbbell_Press'),
  ('Standing Palms-In Dumbbell Press', 'schouders', false, 'intermediate', 'Start by having a dumbbell in each hand with your arm fully extended to the side using a neutral grip. Your feet should be shoulder width apart from each other. Now slowly lift the dumbbells up until you create a 90 degree angle with your arms. Note: Your forearms should be perpendicular to the floor. This the starting position.
...
Repeat for the recommended amount of repetitions.', 'Standing_Palms-In_Dumbbell_Press/0.jpg', 'Standing_Palms-In_Dumbbell_Press'),
  ('Standing Palms-Up Barbell Behind The Back Wrist Curl', 'armen', false, 'beginner', 'Start by standing straight and holding a barbell behind your glutes at arm''s length while using a pronated grip (palms will be facing back away from the glutes) and having your hands shoulder width apart from each other.
...
When finished, lower the barbell down to the squat rack or the floor by bending the knees. Tip: It is easiest to either pick it up from a squat rack or have a partner hand it to you.', 'Standing_Palms-Up_Barbell_Behind_The_Back_Wrist_Curl/0.jpg', 'Standing_Palms-Up_Barbell_Behind_The_Back_Wrist_Curl'),
  ('Standing Rope Crunch', 'core', false, 'beginner', 'Attach a rope to a high pulley and select an appropriate weight.
...
Hold the peak contraction for a moment before returning to the starting position.', 'Standing_Rope_Crunch/0.jpg', 'Standing_Rope_Crunch'),
  ('Standing Towel Triceps Extension', 'armen', false, 'beginner', 'To begin, stand up with both arms fully extended above the head holding one end of a towel with both hands. Your elbows should be in and the arms perpendicular to the floor with the palms facing each other while your feet should be shoulder width apart from each other. This is the starting position.
...
Repeat for the recommended amount of repetitions.', 'Standing_Towel_Triceps_Extension/0.jpg', 'Standing_Towel_Triceps_Extension'),
  ('Step-up with Knee Raise', 'benen', false, 'beginner', 'Stand facing a box or bench of an appropriate height with your feet together. This will be your starting position.
...
Reverse this motion to step down off the box, and then repeat the sequence on the opposite leg.', 'Step-up_with_Knee_Raise/0.jpg', 'Step-up_with_Knee_Raise'),
  ('Stiff-Legged Barbell Deadlift', 'benen', false, 'intermediate', 'Grasp a bar using an overhand grip (palms facing down). You may need some wrist wraps if using a significant amount of weight.
...
Repeat for the recommended amount of repetitions.', 'Stiff-Legged_Barbell_Deadlift/0.jpg', 'Stiff-Legged_Barbell_Deadlift'),
  ('Stiff-Legged Dumbbell Deadlift', 'benen', false, 'beginner', 'Grasp a couple of dumbbells holding them by your side at arm''s length.
...
Repeat for the recommended amount of repetitions.', 'Stiff-Legged_Dumbbell_Deadlift/0.jpg', 'Stiff-Legged_Dumbbell_Deadlift'),
  ('Stiff Leg Barbell Good Morning', 'rug', false, 'beginner', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Repeat for the recommended amount of repetitions.', 'Stiff_Leg_Barbell_Good_Morning/0.jpg', 'Stiff_Leg_Barbell_Good_Morning'),
  ('Straight-Arm Dumbbell Pullover', 'borst', false, 'intermediate', 'Place a dumbbell standing up on a flat bench.
...
Hold the weight on the initial position for a second and repeat the motion for the prescribed number of repetitions.', 'Straight-Arm_Dumbbell_Pullover/0.jpg', 'Straight-Arm_Dumbbell_Pullover'),
  ('Straight-Arm Pulldown', 'rug', false, 'beginner', 'You will start by grabbing the wide bar from the top pulley of a pulldown machine and using a wider than shoulder-width pronated (palms down) grip. Step backwards two feet or so.
...
Repeat for the recommended amount of repetitions.', 'Straight-Arm_Pulldown/0.jpg', 'Straight-Arm_Pulldown'),
  ('Straight Bar Bench Mid Rows', 'rug', false, 'beginner', 'Place a loaded barbell on the end of a bench. Standing on the bench behind the bar, take a medium, pronated grip. Stand with your hips back and chest up, maintaining a neutral spine. This will be your starting position.
...
After a brief pause, slowly return the bar to the starting position, ensuring to go all the way down.', 'Straight_Bar_Bench_Mid_Rows/0.jpg', 'Straight_Bar_Bench_Mid_Rows'),
  ('Straight Raises on Incline Bench', 'schouders', false, 'beginner', 'Place a bar on the ground behind the head of an incline bench.
...
Return to the starting position.', 'Straight_Raises_on_Incline_Bench/0.jpg', 'Straight_Raises_on_Incline_Bench'),
  ('T-Bar Row with Handle', 'rug', false, 'beginner', 'Position a bar into a landmine or in a corner to keep it from moving. Load an appropriate weight onto your end.
...
After a brief pause, return to the starting position.', 'T-Bar_Row_with_Handle/0.jpg', 'T-Bar_Row_with_Handle'),
  ('Tate Press', 'armen', false, 'intermediate', 'Lie down on a flat bench with a dumbbell in each hand on top of your thighs. The palms of your hand will be facing each other.
...
Repeat the movement for the prescribed amount of repetitions of your training program.', 'Tate_Press/0.jpg', 'Tate_Press'),
  ('Thigh Abductor', 'benen', false, 'beginner', 'To begin, sit down on the abductor machine and select a weight you are comfortable with. When your legs are positioned properly, grip the handles on each side. Your entire upper body (from the waist up) should be stationary. This is the starting position.
...
Repeat for the recommended amount of repetitions.', 'Thigh_Adductor/0.jpg', 'Thigh_Adductor'),
  ('Tricep Dumbbell Kickback', 'armen', false, 'beginner', 'Start with a dumbbell in each hand and your palms facing your torso. Keep your back straight with a slight bend in the knees and bend forward at the waist. Your torso should be almost parallel to the floor. Make sure to keep your head up. Your upper arms should be close to your torso and parallel to the floor. Your forearms should be pointed towards the floor as you hold the weights. There should be a 90-degree angle formed between your forearm and upper arm. This is your starting position.
...
Repeat the movement for the prescribed amount of repetitions.', 'Tricep_Dumbbell_Kickback/0.jpg', 'Tricep_Dumbbell_Kickback'),
  ('Triceps Overhead Extension with Rope', 'armen', false, 'beginner', 'Attach a rope to a low pulley. After selecting an appropriate weight, grasp the rope with both hands and face away from the cable.
...
Squeeze your triceps at the top of the movement, and slowly lower the weight back to the start position.', 'Triceps_Overhead_Extension_with_Rope/0.jpg', 'Triceps_Overhead_Extension_with_Rope'),
  ('Triceps Pushdown', 'armen', false, 'beginner', 'Attach a straight or angled bar to a high pulley and grab with an overhand grip (palms facing down) at shoulder width.
...
Repeat for the recommended amount of repetitions.', 'Triceps_Pushdown/0.jpg', 'Triceps_Pushdown'),
  ('Triceps Pushdown - Rope Attachment', 'armen', false, 'beginner', 'Attach a rope attachment to a high pulley and grab with a neutral grip (palms facing each other).
...
Repeat for the recommended amount of repetitions.', 'Triceps_Pushdown_-_Rope_Attachment/0.jpg', 'Triceps_Pushdown_-_Rope_Attachment'),
  ('Triceps Pushdown - V-Bar Attachment', 'armen', false, 'beginner', 'Attach a V-Bar to a high pulley and grab with an overhand grip (palms facing down) at shoulder width.
...
Repeat for the recommended amount of repetitions.', 'Triceps_Pushdown_-_V-Bar_Attachment/0.jpg', 'Triceps_Pushdown_-_V-Bar_Attachment'),
  ('Tuck Crunch', 'core', false, 'beginner', 'To begin, lie down on the floor or an exercise mat with your back pressed against the floor. Your arms should be lying across your sides with the palms facing down.
...
Repeat for the recommended amount of repetitions.', 'Tuck_Crunch/0.jpg', 'Tuck_Crunch'),
  ('Two-Arm Dumbbell Preacher Curl', 'armen', false, 'beginner', 'Grab a dumbbell with each arm and place the upper arms on top of the preacher bench or the incline bench. The dumbbell should be held at shoulder length. This will be your starting position.
...
Squeeze the biceps hard for a second at the contracted position and repeat for the recommended amount of repetitions.', 'Two-Arm_Dumbbell_Preacher_Curl/0.jpg', 'Two-Arm_Dumbbell_Preacher_Curl'),
  ('Two-Arm Kettlebell Clean', 'schouders', false, 'intermediate', 'Place two kettlebells between your feet. To get in the starting position, push your butt back and look straight ahead.
...
Lower the kettlebells back to the starting position and repeat.', 'Two-Arm_Kettlebell_Clean/0.jpg', 'Two-Arm_Kettlebell_Clean'),
  ('Two-Arm Kettlebell Jerk', 'schouders', false, 'intermediate', 'Clean two kettlebells to your shoulders. Clean the kettlebells to your shoulders by extending through the legs and hips as you swing the kettlebells towards your shoulders. Rotate your wrists as you do so, so that the palms face forward. Squat down a few inches and reverse the motion rapidly driving both kettlebells overhead. Immediately after the initial push, squat down again and get under the kettlebells. Once the kettlebells are locked out, stand upright to complete the exercise.', 'Two-Arm_Kettlebell_Jerk/0.jpg', 'Two-Arm_Kettlebell_Jerk'),
  ('Two-Arm Kettlebell Military Press', 'schouders', false, 'intermediate', 'Clean two kettlebells to your shoulders. Clean the kettlebells to your shoulders by extending through the legs and hips as you swing the kettlebells towards your shoulders. Rotate your wrists as you do so, so that the palms face forward.

Press the kettlebells up and out. As the kettlebells pass your head, lean into the weights so that the kettlebells are racked behind your head. Make sure to contract your lats, butt, and stomach for added stability.', 'Two-Arm_Kettlebell_Military_Press/0.jpg', 'Two-Arm_Kettlebell_Military_Press'),
  ('Two-Arm Kettlebell Row', 'rug', false, 'intermediate', 'Place two kettlebells in front of your feet. Bend your knees slightly and then push your butt out as much as possible as you bend over to get in the starting position.

Grab both kettlebells and pull them to your stomach, retracting your shoulder blades and flexing the elbows. Keep your back straight. Lower and repeat.', 'Two-Arm_Kettlebell_Row/0.jpg', 'Two-Arm_Kettlebell_Row'),
  ('Underhand Cable Pulldowns', 'rug', false, 'beginner', 'Sit down on a pull-down machine with a wide bar attached to the top pulley. Adjust the knee pad of the machine to fit your height. These pads will prevent your body from being raised by the resistance attached to the bar.
...
Repeat this motion for the prescribed amount of repetitions.', 'Underhand_Cable_Pulldowns/0.jpg', 'Underhand_Cable_Pulldowns'),
  ('Upright Barbell Row', 'schouders', false, 'beginner', 'Grasp a barbell with an overhand grip that is slightly less than shoulder width. The bar should be resting on the top of your thighs with your arms extended and a slight bend in your elbows. Your back should also be straight. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Upright_Barbell_Row/0.jpg', 'Upright_Barbell_Row'),
  ('Upright Cable Row', 'rug', false, 'intermediate', 'Grasp a straight bar cable attachment that is attached to a low pulley with a pronated (palms facing your thighs) grip that is slightly less than shoulder width. The bar should be resting on top of your thighs. Your arms should be extended with a slight bend at the elbows and your back should be straight. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Upright_Cable_Row/0.jpg', 'Upright_Cable_Row'),
  ('V-Bar Pulldown', 'rug', false, 'intermediate', 'Sit down on a pull-down machine with a V-Bar attached to the top pulley.
...
Repeat for the prescribed number of repetitions.', 'V-Bar_Pulldown/0.jpg', 'V-Bar_Pulldown'),
  ('V-Bar Pullup', 'rug', false, 'beginner', 'Start by placing the middle of the V-bar in the middle of the pull-up bar (assuming that the pull-up station you are using does not have neutral grip handles). The V-Bar handles will be facing down so that you can hang from the pull-up bar through the use of the handles.
...
Repeat for the prescribed number of repetitions.', 'V-Bar_Pullup/0.jpg', 'V-Bar_Pullup'),
  ('Weighted Jump Squat', 'benen', false, 'intermediate', 'Position a lightly loaded barbell across the back of your shoulders. You could also use a weighted vest, sandbag, or other type of resistance for this exercise.
...
As you return to the ground, absorb the impact through your legs.', 'Weighted_Jump_Squat/0.jpg', 'Weighted_Jump_Squat'),
  ('Weighted Sissy Squat', 'benen', false, 'expert', 'Standing upright, with feet at shoulder width and toes raised, use one hand to hold onto the beams of a squat rack and the opposite arm to hold a plate on top of your chest. This is your starting position.
...
Repeat for the recommended amount of times.', 'Weighted_Sissy_Squat/0.jpg', 'Weighted_Sissy_Squat'),
  ('Wide-Grip Barbell Bench Press', 'borst', false, 'intermediate', 'Lie back on a flat bench with feet firm on the floor. Using a wide, pronated (palms forward) grip that is around 3 inches away from shoulder width (for each hand), lift the bar from the rack and hold it straight over you with your arms locked. The bar will be perpendicular to the torso and the floor. This will be your starting position.

As you breathe in, come down slowly until you feel the bar on your middle chest.

After a second pause, bring the bar back to the starting position as you breathe out and push the bar using your chest muscles. Lock your arms and squeeze your chest in the contracted position, hold for a second and then start coming down slowly again. Tip: It should take at least twice as long to go down than to come up.

Repeat the movement for the prescribed amount of repetitions.', 'Wide-Grip_Barbell_Bench_Press/0.jpg', 'Wide-Grip_Barbell_Bench_Press'),
  ('Wide-Grip Decline Barbell Bench Press', 'borst', false, 'intermediate', 'Lie back on a decline bench with the feet securely locked at the front of the bench. Using a wide, pronated (palms forward) grip that is around 3 inches away from shoulder width (for each hand), lift the bar from the rack and hold it straight over you with your arms locked. The bar will be perpendicular to the torso and the floor. This will be your starting position.

As you breathe in, come down slowly until you feel the bar on your lower chest.

After a second pause, bring the bar back to the starting position as you breathe out and push the bar using your chest muscles. Lock your arms and squeeze your chest in the contracted position, hold for a second and then start coming down slowly again. Tip: It should take at least twice as long to go down than to come up.

Repeat the movement for the prescribed amount of repetitions.', 'Wide-Grip_Decline_Barbell_Bench_Press/0.jpg', 'Wide-Grip_Decline_Barbell_Bench_Press'),
  ('Wide-Grip Decline Barbell Pullover', 'borst', false, 'intermediate', 'Lie down on a decline bench with both legs securely locked in position. Reach for the barbell behind the head using a pronated grip (palms facing out). Make sure to grab the barbell wider than shoulder width apart for this exercise. Slowly lift the barbell up from the floor by using your arms.
...
When finished with your set, slowly lower the barbell back down until it is level with your head and release it.', 'Wide-Grip_Decline_Barbell_Pullover/0.jpg', 'Wide-Grip_Decline_Barbell_Pullover'),
  ('Wide-Grip Lat Pulldown', 'rug', false, 'beginner', 'Sit down on a pull-down machine with a wide bar attached to the top pulley. Make sure that you adjust the knee pad of the machine to fit your height. These pads will prevent your body from being raised by the resistance attached to the bar.
...
Repeat this motion for the prescribed amount of repetitions.', 'Wide-Grip_Lat_Pulldown/0.jpg', 'Wide-Grip_Lat_Pulldown'),
  ('Wide-Grip Pulldown Behind The Neck', 'rug', false, 'intermediate', 'Sit down on a pull-down machine with a wide bar attached to the top pulley. Make sure that you adjust the knee pad of the machine to fit your height. These pads will prevent your body from being raised by the resistance attached to the bar.
...
Repeat this motion for the prescribed amount of repetitions.', 'Wide-Grip_Pulldown_Behind_The_Neck/0.jpg', 'Wide-Grip_Pulldown_Behind_The_Neck'),
  ('Wide-Grip Rear Pull-Up', 'rug', false, 'intermediate', 'Grab the pull-up bar with the palms facing forward using a wide grip.
...
Repeat this motion for the prescribed amount of repetitions.', 'Wide-Grip_Rear_Pull-Up/0.jpg', 'Wide-Grip_Rear_Pull-Up'),
  ('Wide-Grip Standing Barbell Curl', 'armen', false, 'beginner', 'Stand up with your torso upright while holding a barbell at the wide outer handle. The palm of your hands should be facing forward. The elbows should be close to the torso. This will be your starting position.
...
Repeat for the recommended amount of repetitions.', 'Wide-Grip_Standing_Barbell_Curl/0.jpg', 'Wide-Grip_Standing_Barbell_Curl'),
  ('Wide Stance Barbell Squat', 'benen', false, 'intermediate', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. Once the correct height is chosen and the bar is loaded, step under the bar and place the back of your shoulders (slightly below the neck) across it.
...
Repeat for the recommended amount of repetitions.', 'Wide_Stance_Barbell_Squat/0.jpg', 'Wide_Stance_Barbell_Squat'),
  ('Wind Sprints', 'core', false, 'beginner', 'Hang from a pull-up bar using a pronated grip. Your arms and legs should be extended. This will be your starting position.
...
Continue alternating between legs until the set is complete.', 'Wind_Sprints/0.jpg', 'Wind_Sprints'),
  ('Wrist Rotations with Straight Bar', 'armen', false, 'beginner', 'Hold a barbell with both hands and your palms facing down; hands spaced about shoulder width. This will be your starting position.
...
Reverse the motion by flexing the wrist, rolling the opposite direction. Continue the alternating motion until failure.', 'Wrist_Rotations_with_Straight_Bar/0.jpg', 'Wrist_Rotations_with_Straight_Bar'),
  ('Zercher Squats', 'benen', false, 'expert', 'This exercise is best performed inside a squat rack for safety purposes. To begin, first set the bar on a rack that best matches your height. The correct height should be anywhere above the waist but below the chest. Once the correct height is chosen and the bar is loaded, lock your hands together and place the bar on top of your arms in between the forearm and upper arm.
...
Repeat for the recommended amount of repetitions.', 'Zercher_Squats/0.jpg', 'Zercher_Squats'),
  ('Zottman Curl', 'armen', false, 'intermediate', 'Stand up with your torso upright and a dumbbell in each hand being held at arms length. The elbows should be close to the torso.
...
Repeat for the recommended amount of repetitions.', 'Zottman_Preacher_Curl/0.jpg', 'Zottman_Preacher_Curl')
